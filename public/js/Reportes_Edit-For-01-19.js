            ...
            for (let i = 1; i <= count; i++) {
                ...
                col.innerHTML = `
                    <div class="form-group">
                        ...
                        <input type="hidden" name="detalles_junta_check[${index}]"
                            id="detallesJuntaValue${index}" value="0">

                        <div class="detalles-junta-container d-none mt-3"
                            id="detallesContainer${index}">

                            <input type="text" class="form-control mt-1"
                                name="junta[${index}]" placeholder="Junta">

                            <input type="text" class="form-control mt-1"
                                name="no_indicacion[${index}]" placeholder="No. Indicación">

                            <input type="text" class="form-control mt-1"
                                name="tipo_indicacion[${index}]" placeholder="Tipo Indicación">

                            <input type="text" class="form-control mt-1"
                                name="longitud[${index}]" placeholder="Longitud">

                            <input type="text" class="form-control mt-1"
                                name="profundidad[${index}]" placeholder="Profundidad">

                            <input type="text" class="form-control mt-1"
                                name="nivel_referencia[${index}]" placeholder="Nivel Referencia">

                            <input type="text" class="form-control mt-1"
                                name="distancia_nivel[${index}]" placeholder="Distancia Nivel">

                            <input type="text" class="form-control mt-1"
                                name="direccion_sonda[${index}]" placeholder="Dirección Sonda">
