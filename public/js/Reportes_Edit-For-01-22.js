                ...
                col.innerHTML = `
                    <div class="form-group">
                        ...
                        <div class="form-check mt-2">
                            <input type="checkbox" class="form-check-input RG-Principal-checkbox" data-index="${index}" id="RG-Principal${index}">
                        ...
                        <div class="form-check mt-2">
                            <input type="checkbox" class="form-check-input RG-Secundario-checkbox" data-index="${index}" id="RG-Secundario${index}">
