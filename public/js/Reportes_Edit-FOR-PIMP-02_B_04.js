(function (window, $) {
    ...
    window.__FOR_PIMP_02_B_04_EDIT_EXTERNAL_CELL_MERGE = true;
    ...
    function inicializarTablaCombinable() {
        ...
        window.__FOR_PIMP_02_B_04_EDIT_CELL_MERGE_MANAGER = window.ReportesCombinacionCeldas.crearAdministrador({
    ...
    // Mantiene consecutiva la numeracion visual al agregar o eliminar filas.
    ...
    // Conecta los comportamientos del formulario edit del formato.
