...
class FOR_01_PRO_INS_22Controller extends Controller
{
    ...
    public function FOR_01_PRO_INS_22_store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'Detalles_Generales.Tipo_de_Fluido' => 'nullable|string|max:255',
            'Detalles_Generales.Partida' => 'nullable|string|max:255',
            'Detalles_Generales.Temperatura_de_Operacion' => 'nullable|string|max:255',
            'Detalles_Generales.Lugar' => 'nullable|string|max:255',
            'Detalles_Generales.Espesor_Nominal_Cedula' => 'nullable|string|max:255',
            ...
            'Detalles_Generales.Diametro_Nominal_NPS' => 'nullable|string|max:255',
            ...
            'Datos_Equipo.DIAMETRO_PULG' => 'nullable|string|max:255',
            'Datos_Equipo.MARCA_AN1' => 'nullable|string|max:255',
            'Datos_Equipo.NS_AN1' => 'nullable|string|max:255',

            'Datos_Equipo.DIAMETRO_PULG_AN2' => 'nullable|string|max:255',
            'Datos_Equipo.MODELO_AN2' => 'nullable|string|max:255',
            'Datos_Equipo.NS_AN2' => 'nullable|string|max:255',

            'Datos_Equipo.Numero_de_Modelos' => 'nullable|string|max:255',
            'Datos_Equipo.NUMERO_DE_TRANSDUCTORES' => 'nullable|string|max:255',

            'Datos_Equipo.Frecuencia' => 'nullable|string|max:255',
            'Datos_Equipo.Orientacion_de_la_Tuberia' => 'nullable|string|max:255',
            'Datos_Equipo.Referencia_de_la_Posicion_del_Anillo' => 'nullable|string|max:255',
            'Datos_Equipo.Modo_de_Onda' => 'nullable|string|max:255',
            'Datos_Equipo.Direccion_del_Disparo' => 'nullable|string|max:255',
            'Datos_Equipo.Distancia_de_Posicion_del_Anillo' => 'nullable|string|max:255',
            'Datos_Equipo.Presion_de_Operacion_del_anillo' => 'nullable|string|max:255',
            'Datos_Equipo.Tipo_de_Recubrimiento' => 'nullable|string|max:255',
            'Datos_Equipo.Angulo_de_Orientacion_del_Anillo' => 'nullable|string|max:255',
            'Datos_Equipo.Coordenadas_GPS' => 'nullable|string|max:255',
