...
class FOR_01_PRO_INS_15Controller extends Controller
{
    ...
    public function FOR_01_PRO_INS_15_store(Request $request)
    {
        ...
        */
        ...
        foreach ($request->images_base64 as $index => $base64Image) {
            ...
            $rutaCarpeta = "public/Reportes/FOR_01_PRO_INS_15/{$Contrato}/{$No_Reporte}/Fotos"; /* Ruta personalizada CAMBIAR */
            ...
            $imagenesGuardadas[] = [
                'ruta' => "storage/Reportes/FOR_01_PRO_INS_15/{$Contrato}/{$No_Reporte}/Fotos/{$imageName}", /* Ruta personalizada CAMBIAR */
    ...
    /*public function FOR_PINS_04_01_update1(Request $request) 
    {
        // Verificar los datos recibidos antes de procesarlos
        dd($request->input('titulos', []), $request->all()); // Mostrar todos los datos que están llegando
    }*/

    public function FOR_01_PRO_INS_15_update(Request $request, $id)
    {
        $Estatus = "ACTUALIZADO";
        // Validar los Detalles_Generales
        $validatedData = $request->validate([
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_01_PRO_INS_15/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
    ...
    public function FOR_01_INS_15($id)
    {
        ...
        $data = [
            'title' => 'Reporte_FOR-01-INS-15.PDF',
            'Logo' => $Logo,
            //Detalles_Generales
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDF.Reporte_FOR_01_INS_15_PDF', $data)->setPaper('letter', 'landscape');
