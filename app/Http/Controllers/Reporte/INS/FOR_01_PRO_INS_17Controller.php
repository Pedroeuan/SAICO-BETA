...
class FOR_01_PRO_INS_17Controller extends Controller
{
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        $directorioTemporal = storage_path("app/temp_pdfs/FOR_01_PRO_INS_17/{$Contrato}/{$No_Reporte}");
        ...
        $directorioQR = storage_path("app/public/Reportes/FOR_01_PRO_INS_17/{$Contrato}/{$No_Reporte}/QR_REPORTES");
        ...
        $rutaQrPublica = "storage/Reportes/FOR_01_PRO_INS_17/{$Contrato}/{$No_Reporte}/QR_REPORTES/" . $nombreQR;
        ...
        $directorioFinal = "Reportes/FOR_01_PRO_INS_17/{$Contrato}/{$No_Reporte}/";
        ...
        $nombreArchivoFinal = "QR_FOR_01_PRO_INS_17_{$Contrato}_{$No_Reporte}.pdf";
    ...
    public function FOR_01_PRO_INS_17_store(Request $request)
    {
        $Estatus = "CREADO";
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            if ($base64) {
                ...
                $imagenesGuardadas[] = [
                    'imagen' => $i,
                    'ruta' => "storage/Reportes/FOR_01_PRO_INS_17/{$Contrato}/{$No_Reporte}/Fotos/{$nombreImagen}"
                ];
            }
        }
    ...
    public function FOR_01_INS_17($id)
    {
        // Encontrar el Reporte, Fotos_Reportes, Firmas_Reportes, Grupo_Juntas_Detalles_Re para actualizar los datos en la base de datos
        $Reporte = reporte::where('idReportes', $id)->first();
        $Grupo_Juntas_Detalles_Re = Grupo_Juntas_Detalles_Re::where('idReportes', $id)->first();
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDF.Reporte_FOR_01_INS_17_PDF', $data)->setPaper('letter', 'portrait');

        // Generar el PDF adicional en orientación vertical
        $pdf2 = PDF::loadView('Reportes.ReportesFotosPDF.Reporte_FOTOS_FOR_01_INS_17_PDF', $data)->setPaper('letter', 'portrait');
       ...
       // Crear objetos FPDI independientes para contar páginas
        ...
        return response($combinedPdf->Output('Reporte_FOR_INS_17_01.PDF', 'I'), 200)
