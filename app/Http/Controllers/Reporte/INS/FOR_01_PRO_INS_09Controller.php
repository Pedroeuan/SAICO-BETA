...
class FOR_01_PRO_INS_09Controller extends Controller
{
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        */
        ...
        $directorioTemporal = storage_path("app/temp_pdfs/FOR_01_PRO_INS_09/{$Contrato}/{$No_Reporte}");
        ...
        */
        ...
        $directorioFinal = "Reportes/FOR_01_PRO_INS_09/{$Contrato}/{$No_Reporte}/";
        ...
        */
        ...
        $nombreArchivoFinal = "QR_FOR_01_PRO_INS_09_{$Contrato}_{$No_Reporte}.pdf";
        ...
        */
        ...
        $directorioQR = storage_path("app/public/Reportes/FOR_01_PRO_INS_09/{$Contrato}/{$No_Reporte}/QR_REPORTES");
        ...
        */
        ...
        $rutaQrPublica =
            "storage/Reportes/FOR_01_PRO_INS_09/{$Contrato}/{$No_Reporte}/QR_REPORTES/" . $nombreQR;
        $rutaPdfRelativa =
            "storage/Reportes/FOR_01_PRO_INS_09/{$Contrato}/{$No_Reporte}/" . $nombreArchivoFinal;
    ...
    public function FOR_01_PRO_INS_09_store(Request $request)
    {
        ...
        */
        ...
        foreach ($request->images_base64 as $index => $base64Image) {
            ...
            $rutaCarpeta = "public/Reportes/FOR_01_PRO_INS_09/{$Contrato}/{$No_Reporte}/Fotos"; /* Ruta personalizada CAMBIAR */
            ...
            $imagenesGuardadas[] = [
                'ruta' => "storage/Reportes/FOR_01_PRO_INS_09/{$Contrato}/{$No_Reporte}/Fotos/{$imageName}", /* Ruta personalizada CAMBIAR */
    ...
    public function FOR_01_PRO_INS_09_update(Request $request, $id)
    {
        $Estatus = "ACTUALIZADO";
        // Validar los Detalles_Generales
        $validatedData = $request->validate([
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_01_PRO_INS_09/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
        ...
        */
        ...
        $rutaCarpeta = "public/Reportes/FOR_01_PRO_INS_09/{$Contrato}/{$No_Reporte}/Fotos";
