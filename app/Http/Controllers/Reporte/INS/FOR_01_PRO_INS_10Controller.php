...
class FOR_01_PRO_INS_10Controller extends Controller
{
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        */
        ...
        $directorioTemporal = storage_path("app/temp_pdfs/FOR_01_PRO_INS_10/{$Contrato}/{$No_Reporte}");
        ...
        */
        ...
        $directorioQR = storage_path("app/public/Reportes/FOR_01_PRO_INS_10/{$Contrato}/{$No_Reporte}/QR_REPORTES");
        ...
        $rutaQrPublica = "storage/Reportes/FOR_01_PRO_INS_10/{$Contrato}/{$No_Reporte}/QR_REPORTES/" . $nombreQR;
        ...
        */
        ...
        $directorioFinal = "Reportes/FOR_01_PRO_INS_10/{$Contrato}/{$No_Reporte}/";
        ...
        */
        ...
        $nombreArchivoFinal = "QR_FOR_01_PRO_INS_10_{$Contrato}_{$No_Reporte}.pdf";
    ...
    public function FOR_01_PRO_INS_10_store(Request $request)
    {
        //dd($request->all());
        $Estatus = "CREADO";
        ...
        $validatedData = $request->validate([
            ...
            'Datos_Equipo.TEMP_MAX_OPE' => 'nullable|string',
    ...
    public function FOR_01_PRO_INS_10_update(Request $request, $id)
    {
        $Estatus = "ACTUALIZADO";
        // Validar los Detalles_Generales
        $validatedData = $request->validate([
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_01_PRO_INS_10/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
    ...
    public function FOR_01_INS_10($id)
    {
        // Encontrar el Reporte, Fotos_Reportes, Firmas_Reportes, Grupo_Juntas_Detalles_Re para actualizar los datos en la base de datos
        $Reporte = reporte::where('idReportes', $id)->first();
        $Grupo_Juntas_Detalles_Re = Grupo_Juntas_Detalles_Re::where('idReportes', $id)->first();
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDF.Reporte_FOR_01_INS_10_PDF', $data)->setPaper('letter', 'landscape');

        // Generar el PDF adicional en orientación vertical
        $pdf2 = PDF::loadView('Reportes.ReportesFotosPDF.Reporte_FOTOS_FOR_01_INS_10_PDF', $data)->setPaper('letter', 'portrait');
