...
class FOR_01_PRO_INS_06Controller extends Controller
{
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        */
        ...
        $directorioTemporal = storage_path(
            "app/temp_pdfs/FOR_01_PRO_INS_06/{$Contrato}/{$No_Reporte}"
        );
        ...
        */
        ...
        $directorioFinal =
            "Reportes/FOR_01_PRO_INS_06/{$Contrato}/{$No_Reporte}/";
        ...
        */
        ...
        $nombreArchivoFinal =
            "QR_FOR_01_PRO_INS_06_{$Contrato}_{$No_Reporte}.pdf";
        ...
        */
        ...
        $directorioQR = storage_path(
            "app/public/Reportes/FOR_01_PRO_INS_06/{$Contrato}/{$No_Reporte}/QR_REPORTES"
        );
        ...
        */
        ...
        $rutaQrPublica =
            "storage/Reportes/FOR_01_PRO_INS_06/{$Contrato}/{$No_Reporte}/QR_REPORTES/"
            . $nombreQR;

        $rutaPdfRelativa =
            "storage/Reportes/FOR_01_PRO_INS_06/{$Contrato}/{$No_Reporte}/"
            . $nombreArchivoFinal;
    ...
    public function FOR_01_PRO_INS_06_store(Request $request)
    {
        ...
        */
        ...
        foreach ($request->images_base64 as $index => $base64Image) {
            ...
            $rutaCarpeta = "public/Reportes/FOR_01_PRO_INS_06/{$Contrato}/{$No_Reporte}/Fotos";
            ...
            $imagenesGuardadas[] = [
                'ruta' => "storage/Reportes/FOR_01_PRO_INS_06/{$Contrato}/{$No_Reporte}/Fotos/{$imageName}",
    ...
    public function FOR_01_PRO_INS_06_update(Request $request, $id)
    {
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_01_PRO_INS_06/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
    ...
    public function FOR_01_INS_06($id)
    {
        // Encontrar el Reporte, Fotos_Reportes, Firmas_Reportes, Grupo_Juntas_Detalles_Re para actualizar los datos en la base de datos
        $Reporte = reporte::where('idReportes', $id)->first();
        $Grupo_Juntas_Detalles_Re = Grupo_Juntas_Detalles_Re::where('idReportes', $id)->first();
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDF.Reporte_FOR_01_INS_06_PDF', $data)->setPaper('letter', 'landscape');

        // Generar el PDF adicional en orientación vertical
        $pdf2 = PDF::loadView('Reportes.ReportesFotosPDF.Reporte_FOTOS_FOR_01_INS_06_PDF', $data)->setPaper('letter', 'portrait');
       ...
       // Crear objetos FPDI independientes para contar páginas
        ...
        for ($i = 1; $i <= $pageCount2; $i++) {
            ...
            $combinedPdf->SetFont('Arial', 'B', 8);
            $combinedPdf->SetXY(143, -266.5);
            // Para que el conteo sea consecutivo
            $combinedPdf->Cell(0, 10, ($i + $pageCount1) . " de $totalPageCount", 0, 0, 'C');
        }

        return response($combinedPdf->Output('Reporte_FOR_01_INS_06.PDF', 'I'), 200)
