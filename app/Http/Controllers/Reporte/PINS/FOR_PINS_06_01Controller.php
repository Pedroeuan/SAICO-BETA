...
class FOR_PINS_06_01Controller extends Controller
{
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        */
        ...
        $directorioTemporal = storage_path(
            "app/temp_pdfs/FOR_PINS_06_01/{$Contrato}/{$No_Reporte}"
        );
        ...
        */
        ...
        $directorioFinal =
            "Reportes/FOR_PINS_06_01/{$Contrato}/{$No_Reporte}/";
        ...
        */
        ...
        $nombreArchivoFinal =
            "QR_FOR_PINS_06_01_{$Contrato}_{$No_Reporte}.pdf";
        ...
        */
        ...
        $directorioQR = storage_path(
            "app/public/Reportes/FOR_PINS_06_01/{$Contrato}/{$No_Reporte}/QR_REPORTES"
        );
        ...
        */
        ...
        $rutaQrPublica =
            "storage/Reportes/FOR_PINS_06_01/{$Contrato}/{$No_Reporte}/QR_REPORTES/"
            . $nombreQR;

        $rutaPdfRelativa =
            "storage/Reportes/FOR_PINS_06_01/{$Contrato}/{$No_Reporte}/"
            . $nombreArchivoFinal;
    ...
    public function FOR_PINS_06_01_store1(Request $request)
    {
    ...
    public function FOR_PINS_06_01_store(Request $request)
    {
        $Estatus = "CREADO";
        ...
        $validatedData = $request->validate([
            ...
            'Datos_Equipo.TAMANO1_TRANSDUCTORES' => 'nullable|string|max:255',
            'Datos_Equipo.ANGULO2_TRANSDUCTORES' => 'nullable|string|max:255',
            'Datos_Equipo.FRECUENCIA2_TRANSDUCTORES' => 'nullable|string|max:255',
            'Datos_Equipo.TAMANO2_TRANSDUCTORES' => 'nullable|string|max:255',
            'Datos_Equipo.ANGULO3_TRANSDUCTORES' => 'nullable|string|max:255',
            'Datos_Equipo.FRECUENCIA3_TRANSDUCTORES' => 'nullable|string|max:255',
            'Datos_Equipo.TAMANO3_TRANSDUCTORES' => 'nullable|string|max:255',

            'Datos_Equipo.AC_MARCA' => 'nullable|string|max:255',
            'Datos_Equipo.AC_TIPO' => 'nullable|string|max:255',

            'Datos_Equipo.BLOQUES1_MARCA' => 'nullable|string|max:255',
            'Datos_Equipo.BLOQUES1_TIPO' => 'nullable|string|max:255',
            'Datos_Equipo.BLOQUES2_MARCA' => 'nullable|string|max:255',
            'Datos_Equipo.BLOQUES2_TIPO' => 'nullable|string|max:255',
            'Datos_Equipo.BLOQUES3_MARCA' => 'nullable|string|max:255',
            'Datos_Equipo.BLOQUES3_TIPO' => 'nullable|string|max:255',
            ...
            'Datos_Equipo.QR_TOKEN' => 'nullable|string|max:255',
            'Datos_Equipo.QR_PDF' => 'nullable|string|max:255',
            'Datos_Equipo.PDF_UNIFICADO' => 'nullable|string|max:255',
        ...
        // DespuÃ©s de $validatedData = $request->validate(...)
        ...
        */
        ...
        // Actualizar el registro reciÃ©n creado con las rutas
        /*
        |--------------------------------------------------------------------------
    ...
    public function FOR_PINS_06_01_update1(Request $request)
    {
        // Verificar los datos recibidos antes de procesarlos
       // dd($request->input('titulos', []), $request->all()); // Mostrar todos los datos que están llegando
    }
    ...
    public function FOR_PINS_06_01_update(Request $request, $id)
    {
        $Estatus = "ACTUALIZADO";
        // Validar los Detalles_Generales
        $validatedData = $request->validate([
        ...
        $idEquipo = $validatedData['Datos_Equipo']['ID_EQUIPO']
            ...
            ?? null;
        $validatedData['Datos_Equipo']['ID_EQUIPO'] = $idEquipo;
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_PINS_06_01/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
        ...
        */
        ...
        $rutaCarpeta = "public/Reportes/FOR_PINS_06_01/{$Contrato}/{$No_Reporte}/Fotos";
    ...
    public function FOR_PINS_06_01($id)
    {
        // Encontrar el Reporte, Fotos_Reportes, Firmas_Reportes, Grupo_Juntas_Detalles_Re para actualizar los datos en la base de datos
        $Reporte = reporte::where('idReportes', $id)->first();
        $Grupo_Juntas_Detalles_Re = Grupo_Juntas_Detalles_Re::where('idReportes', $id)->first();
        ...
        $data = [
            'title' => 'Reporte_FOR-PINS-06_01.PDF',
            'QR_PDF' => $qrPdf,
            'Logo' => $Logo,
            //Detalles_Generales
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDF.Reporte_FOR_PINS_06_01_PDF', $data)->setPaper('letter', 'portrait');

        // Generar el PDF adicional en orientación vertical
        $pdf2 = PDF::loadView('Reportes.ReportesFotosPDF.Reporte_FOTOS_FOR_PINS_06_01_PDF', $data)->setPaper('letter', 'portrait');
       ...
       // Crear objetos FPDI independientes para contar páginas
        ...
        return response($combinedPdf->Output('Reporte_FOR_PINS_06_01.PDF', 'I'), 200)
