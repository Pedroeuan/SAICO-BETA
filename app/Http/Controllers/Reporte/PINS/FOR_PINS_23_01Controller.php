...
class FOR_PINS_23_01Controller extends Controller
{
    ...
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        $idsConsumibles = array_filter([
            ...
            $datosParaCrearQR['idAn1'] ?? null,
            $datosParaCrearQR['idAn2'] ?? null,
        ]);
        ...
        */
        ...
        $directorioQR = storage_path(
            "app/public/Reportes/FOR_PINS_23_01/{$Contrato}/{$No_Reporte}/QR_REPORTES"
        );
        ...
        $rutaQrPublica =
            "storage/Reportes/FOR_PINS_23_01/{$Contrato}/{$No_Reporte}/QR_REPORTES/"
            . $nombreQR;
        ...
        */
        ...
        $directorioTemporal = storage_path(
            "app/temp_pdfs/FOR_PINS_23_01/{$Contrato}/{$No_Reporte}"
        );
        ...
        */
        ...
        $directorioFinal = storage_path(
            "app/public/Reportes/FOR_PINS_23_01/{$Contrato}/{$No_Reporte}/PDF_UNIFICADO"
        );
        ...
        $rutaPublicaFinal =
            "storage/Reportes/FOR_PINS_23_01/{$Contrato}/{$No_Reporte}/PDF_UNIFICADO/"
            . $nombrePdfFinal;
    ...
    /*public function FOR_PINS_23_01_store1(Request $request)
    {
    ...
    public function FOR_PINS_23_01_store(Request $request)
    {
        //dd($request->all());
        $Estatus = "CREADO";
        ...
        $validatedData = $request->validate([
            ...
            'Detalles_Generales.Tipo_Flu' => 'nullable|string',
            'Detalles_Generales.Partida' => 'nullable|string',
            'Detalles_Generales.Temp_Op' => 'nullable|string',
            ...
            'Detalles_Generales.Dia_NPS' => 'nullable|string',
            ...
            'Datos_Equipo.DIAMETRO_PULG' => 'nullable|string',
            'Datos_Equipo.MARCA_AN1' => 'nullable|string',
            'Datos_Equipo.NS_AN1' => 'nullable|string',
            'Datos_Equipo.ID_AN1' => 'nullable|string|max:255',

            'Datos_Equipo.DIAMETRO_AN2' => 'nullable|string',
            'Datos_Equipo.MODELO_AN2' => 'nullable|string',
            'Datos_Equipo.NS_AN2' => 'nullable|string',
            'Datos_Equipo.ID_AN2' => 'nullable|string|max:255',

            'Datos_Equipo.Num_Mode' => 'nullable|string',
            'Datos_Equipo.NUM_TRANS' => 'nullable|string',

            'Datos_Equipo.Frecuencia' => 'nullable|string',
            'Datos_Equipo.Ori_Tube' => 'nullable|string',
            'Datos_Equipo.Ref_An' => 'nullable|string',
            'Datos_Equipo.Mod_Onda' => 'nullable|string',
            'Datos_Equipo.Dir_Dis' => 'nullable|string',
            'Datos_Equipo.Dm_An' => 'nullable|string',
            'Datos_Equipo.Psi_an' => 'nullable|string',
            'Datos_Equipo.Tip_Rec' => 'nullable|string',
        ...
        */
        ...
        foreach ($imagesBase64 as $index => $base64Image) {
            ...
            $rutaCarpeta = "public/Reportes/FOR_PINS_23_01/{$Contrato}/{$No_Reporte}/Fotos";
            ...
            $imagenesGuardadas[] = [
                'ruta' => "storage/Reportes/FOR_PINS_23_01/{$Contrato}/{$No_Reporte}/Fotos/{$imageName}",
    ...
    /*public function FOR_PINS_22_01_update1(Request $request) 
    {
        // Verificar los datos recibidos antes de procesarlos
        dd($request->input('titulos', []), $request->all()); // Mostrar todos los datos que están llegando
    }*/
    ...
    public function FOR_PINS_23_01_update(Request $request, $id)
    {
        $Estatus = "ACTUALIZADO";
        // Validar los Detalles_Generales
        $validatedData = $request->validate([
       ...
       // Obtener el valor de 'Detalles_Generales.Contrato'
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_PINS_23_01/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
        ...
        */
        ...
        $validatedData['Datos_Equipo']['ID_AN1'] = $validatedData['Datos_Equipo']['ID_AN1'] ?? ($datosEquipoActuales['ID_AN1'] ?? null);
        $validatedData['Datos_Equipo']['ID_AN2'] = $validatedData['Datos_Equipo']['ID_AN2'] ?? ($datosEquipoActuales['ID_AN2'] ?? null);
        ...
        */
        ...
        $idAn2 = $validatedData['Datos_Equipo']['ID_AN2'] ?? null;
        $idSolicitud = $validatedData['Detalles_Generales']['idSolicitud']
            ?? ($detallesActuales['idSolicitud'] ?? null);
    ...
    public function FOR_PINS_23_01($id)
    {
        // Encontrar el Reporte, Fotos_Reportes, Firmas_Reportes, Grupo_Juntas_Detalles_Re para actualizar los datos en la base de datos
        $Reporte = reporte::where('idReportes', $id)->first();
        $Grupo_Juntas_Detalles_Re = Grupo_Juntas_Detalles_Re::where('idReportes', $id)->first();
        ...
        $data = [
            'title' => 'Reporte_FOR-PINS-23-01.PDF',
            'QR_PDF' => $qrPdf,
            'Logo' => $Logo,
            //Detalles_Generales
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDF.Reporte_FOR_PINS_23_01_PDF', $data)->setPaper('letter', 'landscape');

        // Generar el PDF adicional en orientación vertical
        $pdf2 = PDF::loadView('Reportes.ReportesFotosPDF.Reporte_FOTOS_FOR_PINS_23_01_PDF', $data)->setPaper('letter', 'portrait');
       ...
       // Crear objetos FPDI independientes para contar páginas
        ...
        return response($combinedPdf->Output('Reporte_FOR_PINS_23_01.PDF', 'I'), 200)
