...
class FOR_PINS_10_01Controller extends Controller
{
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        */
        ...
        $directorioTemporal = storage_path("app/temp_pdfs/FOR_PINS_10_01/{$Contrato}/{$No_Reporte}");
        ...
        */
        ...
        $directorioFinal = "Reportes/FOR_PINS_10_01/{$Contrato}/{$No_Reporte}/";
        ...
        */
        ...
        $nombreArchivoFinal = "QR_FOR_PINS_10_01_{$Contrato}_{$No_Reporte}.pdf";
        ...
        */
        ...
        $directorioQR = storage_path("app/public/Reportes/FOR_PINS_10_01/{$Contrato}/{$No_Reporte}/QR_REPORTES");
        ...
        */
        ...
        $rutaQrPublica =
            "storage/Reportes/FOR_PINS_10_01/{$Contrato}/{$No_Reporte}/QR_REPORTES/" . $nombreQR;
        $rutaPdfRelativa =
            "storage/Reportes/FOR_PINS_10_01/{$Contrato}/{$No_Reporte}/" . $nombreArchivoFinal;
        ...
        */
        ...
        foreach ($pdfsTemporales as $archivoTemporal) {
            ...
            $archivoCompatible = str_replace('.pdf', '_compatible.pdf', $archivoTemporal);
    ...
    public function FOR_PINS_10_01_store(Request $request)
    {
        $Estatus = "CREADO";
        ...
        */
        ...
        foreach ($request->images_base64 as $index => $base64Image) {
            ...
            $rutaCarpeta = "public/Reportes/FOR_PINS_10_01/{$Contrato}/{$No_Reporte}/Fotos"; /* Ruta personalizada CAMBIAR */
            ...
            $imagenesGuardadas[] = [
                'ruta' => "storage/Reportes/FOR_PINS_10_01/{$Contrato}/{$No_Reporte}/Fotos/{$imageName}", /* Ruta personalizada CAMBIAR */
    ...
    public function FOR_PINS_10_01_update(Request $request, $id)
    {
        $Estatus = "ACTUALIZADO";
        // Validar los Detalles_Generales
        $validatedData = $request->validate([
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_PINS_10_01/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
        ...
        */
        ...
        $rutaCarpeta = "public/Reportes/FOR_PINS_10_01/{$Contrato}/{$No_Reporte}/Fotos";
    ...
    public function FOR_PINS_10_01($id)
    {
        // Encontrar el Reporte, Fotos_Reportes, Firmas_Reportes, Grupo_Juntas_Detalles_Re para actualizar los datos en la base de datos
        $Reporte = reporte::where('idReportes', $id)->first();
        $Grupo_Juntas_Detalles_Re = Grupo_Juntas_Detalles_Re::where('idReportes', $id)->first();
        ...
        $FOR_PINS_10_01 = public_path('images/FOR-PINS-10_01.png');
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDF.Reporte_FOR_PINS_10_01_PDF', $data)->setPaper('letter', 'portrait');

        // Generar el PDF adicional en orientación vertical
        $pdf2 = PDF::loadView('Reportes.ReportesFotosPDF.Reporte_FOTOS_FOR_PINS_10_01_PDF', $data)->setPaper('letter', 'portrait');
       ...
       // Crear objetos FPDI independientes para contar páginas
        ...
        for ($i = 1; $i <= $pageCount2; $i++) {
            ...
            $combinedPdf->useTemplate($tplId, 0, 0, 210, 297);
            $combinedPdf->SetFont('Arial', 'B', 8);
            $combinedPdf->SetXY(143.5, -267.5);
            // Para que el conteo sea consecutivo
            $combinedPdf->Cell(0, 10, ($i + $pageCount1) . " de $totalPageCount", 0, 0, 'C');
        }

        return response($combinedPdf->Output('Reporte_FOR_PINS_10_01.PDF', 'I'), 200)
