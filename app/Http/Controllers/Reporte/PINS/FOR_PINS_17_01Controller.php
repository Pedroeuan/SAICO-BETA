...
class FOR_PINS_17_01Controller extends Controller
{
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        $directorioTemporal = storage_path("app/temp_pdfs/FOR_PINS_17_01/{$Contrato}/{$No_Reporte}");
        ...
        $directorioQR = storage_path("app/public/Reportes/FOR_PINS_17_01/{$Contrato}/{$No_Reporte}/QR_REPORTES");
        ...
        $rutaQrPublica = "storage/Reportes/FOR_PINS_17_01/{$Contrato}/{$No_Reporte}/QR_REPORTES/" . $nombreQR;
        ...
        $directorioFinal = "Reportes/FOR_PINS_17_01/{$Contrato}/{$No_Reporte}/";
        ...
        $nombreArchivoFinal = "QR_FOR_PINS_17_01_{$Contrato}_{$No_Reporte}.pdf";
    ...
    public function FOR_PINS_17_01_store(Request $request)
    {
        $Estatus = "CREADO";
        ...
        $rutaCarpeta = "public/Reportes/FOR_PINS_17_01/{$Contrato}/{$No_Reporte}/Fotos";
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            if ($base64) {
                ...
                $imagenesGuardadas[] = [
                    'imagen' => $i,
                    'ruta' => "storage/Reportes/FOR_PINS_17_01/{$Contrato}/{$No_Reporte}/Fotos/{$nombreImagen}"
                ];
            }
        }
    ...
    public function FOR_PINS_17_01_update1(Request $request) 
    {
    ...
    public function FOR_PINS_17_01_update(Request $request, $id)
    {
        $Estatus = "ACTUALIZADO";
        // Validar los Detalles_Generales
        $validatedData = $request->validate([
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_PINS_17_01/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
    ...
    public function FOR_PINS_17_01($id)
    {
        // Encontrar el Reporte, Fotos_Reportes, Firmas_Reportes, Grupo_Juntas_Detalles_Re para actualizar los datos en la base de datos
        $Reporte = reporte::where('idReportes', $id)->first();
        $Grupo_Juntas_Detalles_Re = Grupo_Juntas_Detalles_Re::where('idReportes', $id)->first();
        ...
        $data = [
            'title' => 'Reporte_FOR_PINS_17_01.PDF',
            'Logo' => $Logo,
            //Detalles_Generales
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDF.Reporte_FOR_PINS_17_01_PDF', $data)->setPaper('letter', 'portrait');

        // Generar el PDF adicional en orientación vertical
        $pdf2 = PDF::loadView('Reportes.ReportesFotosPDF.Reporte_FOTOS_FOR_PINS_17_01_PDF', $data)->setPaper('letter', 'portrait');
       ...
       // Crear objetos FPDI independientes para contar páginas
        ...
        for ($i = 1; $i <= $pageCount2; $i++) {
            ...
            if ($i == $pageCount2) {
                $combinedPdf->SetXY(140.5, -264.5);
            } else {
                $combinedPdf->SetXY(140.5, -259.5);
            }
        ...
        return response($combinedPdf->Output('Reporte_FOR_PINS_17_01.PDF', 'I'), 200)
