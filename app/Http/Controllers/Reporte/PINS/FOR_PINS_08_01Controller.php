...
class FOR_PINS_08_01Controller extends Controller
{
    ...
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        $idsConsumibles = array_filter([
            ...
            $datosParaCrearQR['idBlockSen'] ?? null,
            $datosParaCrearQR['idBlockDis'] ?? null,
        ]);
        ...
        */
        ...
        $directorioTemporal = storage_path(
            "app/temp_pdfs/FOR_PINS_08_01/{$Contrato}/{$No_Reporte}"
        );
        ...
        */
        ...
        $directorioFinal =
            "Reportes/FOR_PINS_08_01/{$Contrato}/{$No_Reporte}/";
        ...
        */
        ...
        $nombreArchivoFinal =
            "QR_FOR_PINS_08_01_{$Contrato}_{$No_Reporte}.pdf";
        ...
        */
        ...
        $directorioQR = storage_path(
            "app/public/Reportes/FOR_PINS_08_01/{$Contrato}/{$No_Reporte}/QR_REPORTES"
        );
        ...
        */
        ...
        $rutaQrPublica =
            "storage/Reportes/FOR_PINS_08_01/{$Contrato}/{$No_Reporte}/QR_REPORTES/"
            . $nombreQR;

        $rutaPdfRelativa =
            "storage/Reportes/FOR_PINS_08_01/{$Contrato}/{$No_Reporte}/"
            . $nombreArchivoFinal;
    ...
    public function FOR_PINS_08_01_store(Request $request)
    {
        $Estatus = "CREADO";
        ...
        $validatedData = $request->validate([
            ...
            'Datos_Equipo.ID_BLOCK_SEN' => 'nullable|string',
            'Datos_Equipo.ID_BLOCK_DIS' => 'nullable|string',
        ...
        */
        ...
        $idBlockSen = $validatedData['Datos_Equipo']['ID_BLOCK_SEN'] ?? null;
        $idBlockDis = $validatedData['Datos_Equipo']['ID_BLOCK_DIS'] ?? null;
        ...
        */
        ...
        foreach ($request->images_base64 as $index => $base64Image) {
            ...
            $rutaCarpeta = "public/Reportes/FOR_PINS_08_01/{$Contrato}/{$No_Reporte}/Fotos";
            ...
            $imagenesGuardadas[] = [
                'ruta' => "storage/Reportes/FOR_PINS_08_01/{$Contrato}/{$No_Reporte}/Fotos/{$imageName}",
    ...
    public function FOR_PINS_08_01_update(Request $request, $id)
    {
        $Estatus = "ACTUALIZADO";
        // Validar los Detalles_Generales
        $validatedData = $request->validate([
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_PINS_08_01/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
        ...
        $validatedData['Datos_Equipo']['ID_SONDA1'] =
            $validatedData['Datos_Equipo']['ID_SONDA1']
            ?? $datosEquipoActuales['ID_SONDA1']
            ?? null;
        $validatedData['Datos_Equipo']['ID_SONDA2'] =
            $validatedData['Datos_Equipo']['ID_SONDA2']
            ?? $datosEquipoActuales['ID_SONDA2']
            ?? null;
        $validatedData['Datos_Equipo']['ID_BLOCK_SEN'] =
            $validatedData['Datos_Equipo']['ID_BLOCK_SEN']
            ?? $datosEquipoActuales['ID_BLOCK_SEN']
            ?? null;
        $validatedData['Datos_Equipo']['ID_BLOCK_DIS'] =
            $validatedData['Datos_Equipo']['ID_BLOCK_DIS']
            ?? $datosEquipoActuales['ID_BLOCK_DIS']
            ?? null;
        $validatedData['Datos_Equipo']['QR_TOKEN'] =
            $validatedData['Datos_Equipo']['QR_TOKEN']
     ...
     /*Firmas */
        ...
        $rutaCarpeta = "public/Reportes/FOR_PINS_08_01/{$Contrato}/{$No_Reporte}/Fotos"; /* Ruta personalizada CAMBIAR */
    ...
    public function FOR_PINS_08_01($id)
    {
        // Encontrar el Reporte, Fotos_Reportes, Firmas_Reportes, Grupo_Juntas_Detalles_Re para actualizar los datos en la base de datos
        $Reporte = reporte::where('idReportes', $id)->first();
        $Grupo_Juntas_Detalles_Re = Grupo_Juntas_Detalles_Re::where('idReportes', $id)->first();
        ...
        $FOR_PINS_08_01 = public_path('images/FOR-PINS-08_01.png');
        ...
        $data = [
            'title' => 'Reporte_FOR-PINS-08_01.PDF',
            'Logo' => $Logo,
            'FOR_PINS_08_01' => $FOR_PINS_08_01,
            'QR_PDF' => $qrPdf,
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDF.Reporte_FOR_PINS_08_01_PDF', $data)->setPaper('letter', 'portrait');

        // Generar el PDF adicional en orientación vertical
        $pdf2 = PDF::loadView('Reportes.ReportesFotosPDF.Reporte_FOTOS_FOR_PINS_08_01_PDF', $data)->setPaper('letter', 'portrait');
