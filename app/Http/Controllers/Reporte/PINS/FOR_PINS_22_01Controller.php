...
class FOR_PINS_22_01Controller extends Controller
{
    ...
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        */
        ...
        $directorioTemporal = storage_path(
            "app/temp_pdfs/FOR_PINS_22_01/{$Contrato}/{$No_Reporte}"
        );
        ...
        */
        ...
        $directorioFinal =
            "Reportes/FOR_PINS_22_01/{$Contrato}/{$No_Reporte}/";
        ...
        */
        ...
        $nombreArchivoFinal =
            "QR_FOR_PINS_22_01_{$Contrato}_{$No_Reporte}.pdf";
        ...
        */
        ...
        $directorioQR = storage_path(
            "app/public/Reportes/FOR_PINS_22_01/{$Contrato}/{$No_Reporte}/QR_REPORTES"
        );
        ...
        */
        ...
        $rutaQrPublica =
            "storage/Reportes/FOR_PINS_22_01/{$Contrato}/{$No_Reporte}/QR_REPORTES/"
            . $nombreQR;

        $rutaPdfRelativa =
            "storage/Reportes/FOR_PINS_22_01/{$Contrato}/{$No_Reporte}/"
            . $nombreArchivoFinal;
    ...
    public function FOR_PINS_22_01_store(Request $request)
    {
        $Estatus = "CREADO";
        ...
        $validatedData = $request->validate([
            ...
            'Detalles_Generales.Identificacion' => 'nullable|string',
            'Detalles_Generales.Serie' => 'nullable|string',
            'Detalles_Generales.Fabricante' => 'nullable|string',
            'Detalles_Generales.Numero_Tubos' => 'nullable|string',
            'Detalles_Generales.Diametro' => 'nullable|string',
            'Detalles_Generales.Longitud' => 'nullable|string',
            'Detalles_Generales.Lugar' => 'nullable|string',
            'Detalles_Generales.Año_Fabricacion' => 'nullable|string',
            ...
            'Datos_Equipo.ID_BP' => 'nullable|string',
            ...
            'Datos_Equipo.MARCA_BP' => 'nullable|string',
            'Datos_Equipo.MODELO_BP' => 'nullable|string',
            'Datos_Equipo.NS_BP' => 'nullable|string',
            'Datos_Equipo.FREC_BP' => 'nullable|string',
            ...
            'Datos_Equipo.CER_CALIBRACION' => 'nullable|string',
            'Datos_Equipo.VIG_CALIBRACION' => 'nullable|string',
            ...
            'fase' => 'nullable|array',
            'ganancia' => 'nullable|array',
            'alcanse_inspeccion' => 'nullable|array', 
            'canal' => 'nullable|array',
            'inspeccion' => 'nullable|array',
            'obstruccion' => 'nullable|array',
            'fila' => 'nullable|array',
            'columna' => 'nullable|array',
            'tipo_alarma' => 'nullable|array',
            'longitud_franja' => 'nullable|array',
        ...
        */
        ...
        $idTransductor = $validatedData['Datos_Equipo']['ID_BP'] ?? null;
        ...
        */
                ...
                $agregarElemento([
                    ...
                    'fase' => $request->input("fase.$sinTituloKey.$i"),
                    'ganancia' => $request->input("ganancia.$sinTituloKey.$i"),
                    'alcanse_inspeccion' => $request->input("alcanse_inspeccion.$sinTituloKey.$i"),
                    'canal' => $request->input("canal.$sinTituloKey.$i"),
                    'inspeccion' => $request->input("inspeccion.$sinTituloKey.$i"),
                    'obstruccion' => $request->input("obstruccion.$sinTituloKey.$i"),
                    'fila' => $request->input("fila.$sinTituloKey.$i"),
                    'columna' => $request->input("columna.$sinTituloKey.$i"),
                    'tipo_alarma' => $request->input("tipo_alarma.$sinTituloKey.$i"),
                    'longitud_franja' => $request->input("longitud_franja.$sinTituloKey.$i"),
        ...
        foreach ($titulos as $tituloObj) {
            ...
            for ($i = 0; $i < $numFilas; $i++) {
                $agregarElemento([
                    ...
                    'fase' => $request->input("fase.$tituloKey.$i"),
                    'ganancia' => $request->input("ganancia.$tituloKey.$i"),
                    'alcanse_inspeccion' => $request->input("alcanse_inspeccion.$tituloKey.$i"),
                    'canal' => $request->input("canal.$tituloKey.$i"),
                    'inspeccion' => $request->input("inspeccion.$tituloKey.$i"),
                    'obstruccion' => $request->input("obstruccion.$tituloKey.$i"),
                    'fila' => $request->input("fila.$tituloKey.$i"),
                    'columna' => $request->input("columna.$tituloKey.$i"),
                    'tipo_alarma' => $request->input("tipo_alarma.$tituloKey.$i"),
                    'longitud_franja' => $request->input("longitud_franja.$tituloKey.$i"),
        ...
        */
        ...
        foreach ($request->images_base64 as $index => $base64Image) {
            ...
            $rutaCarpeta = "public/Reportes/FOR_PINS_22_01/{$Contrato}/{$No_Reporte}/Fotos"; /* Ruta personalizada CAMBIAR */
            ...
            $imagenesGuardadas[] = [
                'ruta' => "storage/Reportes/FOR_PINS_22_01/{$Contrato}/{$No_Reporte}/Fotos/{$imageName}", /* Ruta personalizada CAMBIAR */
        ...
        $Contrato = $validatedData['Detalles_Generales']['Contrato'];
        $Proyecto = $validatedData['Detalles_Generales']['Identificacion'] ?? '';
        $Material = $validatedData['Detalles_Generales']['Material'];
        $idSolicitud = $validatedData['Detalles_Generales']['idSolicitud'];
        $Isometrico_Plano = $validatedData['Detalles_Generales']['Serie'] ?? '';
    ...
    public function FOR_PINS_22_01_update(Request $request, $id)
    {
        $Estatus = "ACTUALIZADO";
        // Validar los Detalles_Generales
        $validatedData = $request->validate([
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_PINS_22_01/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
        ...
        */
        ...
        $rutaCarpeta = "public/Reportes/FOR_PINS_22_01/{$Contrato}/{$No_Reporte}/Fotos";
    ...
    public function FOR_PINS_22_01($id)
    {
        // Encontrar el Reporte, Fotos_Reportes, Firmas_Reportes, Grupo_Juntas_Detalles_Re para actualizar los datos en la base de datos
        $Reporte = reporte::where('idReportes', $id)->first();
        $Grupo_Juntas_Detalles_Re = Grupo_Juntas_Detalles_Re::where('idReportes', $id)->first();
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDF.Reporte_FOR_PINS_22_01_PDF', $data)->setPaper('letter', 'landscape');

        // Generar el PDF adicional en orientación vertical
        $pdf2 = PDF::loadView('Reportes.ReportesFotosPDF.Reporte_FOTOS_FOR_PINS_22_01_PDF', $data)->setPaper('letter', 'portrait');
       ...
       // Crear objetos FPDI independientes para contar páginas
        ...
        return response($combinedPdf->Output('Reporte_FOR_PINS_22_01.PDF', 'I'), 200)
