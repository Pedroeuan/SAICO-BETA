...
class FOR_PINS_18_01Controller extends Controller
{
    ...
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        $ID_TECNICO = $datosParaCrearQR['ID_TECNICO'] ?? null;
        ...
        */
        ...
        $directorioTemporal = storage_path("app/temp_pdfs/FOR_PINS_18_01/{$Contrato}/{$No_Reporte}");
        ...
        */
        ...
        $directorioQR = storage_path("app/public/Reportes/FOR_PINS_18_01/{$Contrato}/{$No_Reporte}/QR_REPORTES");
        ...
        $rutaQrPublica = "storage/Reportes/FOR_PINS_18_01/{$Contrato}/{$No_Reporte}/QR_REPORTES/" . $nombreQR;
        ...
        */
        ...
        $directorioFinal = "Reportes/FOR_PINS_18_01/{$Contrato}/{$No_Reporte}/";
        ...
        */
        ...
        $nombreArchivoFinal = "QR_FOR_PINS_18_01_{$Contrato}_{$No_Reporte}.pdf";
    ...
    public function FOR_PINS_18_01_store(Request $request)
    {
        $Estatus = "CREADO";
        ...
        */
        ...
        $maxFilasPorBloque = 13; //Agregar 1 + que en create y edit para que la longitud entre en el mismo bloque
        ...
        */
        ...
        foreach ($request->images_base64 as $index => $base64Image) {
            ...
            $rutaCarpeta = "public/Reportes/FOR_PINS_18_01/{$Contrato}/{$No_Reporte}/Fotos";
            ...
            $imagenesGuardadas[] = [
                'ruta' => "storage/Reportes/FOR_PINS_18_01/{$Contrato}/{$No_Reporte}/Fotos/{$imageName}",
    ...
    /*public function debug_update1(Request $request)
    {
    ...
    public function FOR_PINS_18_01_update(Request $request, $id)
    {
        $Estatus = "ACTUALIZADO";
        // Validar los Detalles_Generales
        $validatedData = $request->validate([
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_PINS_18_01/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
        ...
        foreach ($camposEquipo as $campo) {
            if (
                array_key_exists($campo, $datosEquipoActuales)
                && trim((string) ($validatedData['Datos_Equipo'][$campo] ?? '')) === ''
                && trim((string) $datosEquipoActuales[$campo]) !== ''
            ) {
                $validatedData['Datos_Equipo'][$campo] = $datosEquipoActuales[$campo];
            }
        }
    ...
    public function FOR_PINS_18_01($id)
    {
        // Encontrar el Reporte, Fotos_Reportes, Firmas_Reportes, Grupo_Juntas_Detalles_Re para actualizar los datos en la base de datos
        $Reporte = reporte::where('idReportes', $id)->first();
        $Grupo_Juntas_Detalles_Re = Grupo_Juntas_Detalles_Re::where('idReportes', $id)->first();
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDF.Reporte_FOR_PINS_18_01_PDF', $data)->setPaper('letter', 'portrait');

        // Generar el PDF adicional en orientación vertical
        $pdf2 = PDF::loadView('Reportes.ReportesFotosPDF.Reporte_FOTOS_FOR_PINS_18_01_PDF', $data)->setPaper('letter', 'portrait');
       ...
       // Crear objetos FPDI independientes para contar páginas
        ...
        return response($combinedPdf->Output('Reporte_FOR_PINS_18_01.PDF', 'I'), 200)
