...
class FOR_PIMP_05_01Controller extends Controller
{
    public function Datos_QR($datosParaCrearQR)
    {
        ...
        */
        ...
        $directorioTemporal = storage_path("app/temp_pdfs/FOR_PIMP_05_01/{$Contrato}/{$No_Reporte}");
        ...
        */
        ...
        $directorioQR = storage_path("app/public/Reportes/FOR_PIMP_05_01/{$Contrato}/{$No_Reporte}/QR_REPORTES");
        ...
        $rutaQrPublica = "storage/Reportes/FOR_PIMP_05_01/{$Contrato}/{$No_Reporte}/QR_REPORTES/" . $nombreQR;
        ...
        */
        ...
        $directorioFinal = "Reportes/FOR_PIMP_05_01/{$Contrato}/{$No_Reporte}/";
        ...
        $nombreArchivoFinal = "QR_FOR_PIMP_05_01_{$Contrato}_{$No_Reporte}.pdf";
    ...
    public function FOR_PIMP_05_01_store(Request $request)
    {
        $Estatus = "CREADO";
        ...
        */
        ...
        foreach ($imagesBase64 as $index => $base64Image) {
            ...
            $rutaCarpeta = "public/Reportes/FOR_PIMP_05_01/{$Contrato}/{$No_Reporte}/Fotos";
            ...
            $imagenesGuardadas[] = [
                'ruta' => "storage/Reportes/FOR_PIMP_05_01/{$Contrato}/{$No_Reporte}/Fotos/{$imageName}",
    ...
    public function FOR_PIMP_05_01_update(Request $request, $id)
    {
        $Estatus = "ACTUALIZADO";
        // Validar los Detalles_Generales
        $validatedData = $request->validate([
        ...
        if ($request->hasFile('Detalles_Generales.Reporte_Firmado')) {
            ...
            $rutaBase = "public/Reportes/FOR_PIMP_05_01/{$Contrato}/{$No_Reporte}/Reporte_Firmado";
    ...
    public function FOR_PIMP_05_01($id)
    {
        ...
        $data = [
            'title' => 'Reporte_FOR-PIMP-05-01.PDF',
            'Logo' => $Logo,
            //Detalles_Generales
        ...
        $pdf1 = PDF::loadView('Reportes.ReportesPDFIM.Reporte_FOR_PIMP_05_01_PDF', $data)->setPaper('letter', 'portrait');
        $pdf2Content = null;
        $pageCount2 = 0;

        if (!empty($Fotos)) {
            $pdf2 = PDF::loadView('Reportes.ReportesFotosPDFIM.Reporte_FOTOS_FOR_PIMP_05_01_PDF', $data)->setPaper('letter', 'portrait');
       ...
       // Crear objetos FPDI independientes para contar páginas
        ...
        return response($combinedPdf->Output('Reporte_FOR_PIMP_05_01.PDF', 'S'), 200)
