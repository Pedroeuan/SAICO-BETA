...
class FOR_PIMP_05_B_01Controller extends Controller
{
    ...
    private function construirNormaIM(Request $request, ?array $normaHistorica = null): ?array
    {
        ...
        if ($nuevoPdf) {
            ...
            if (count($columnasSeleccionadas) !== 3) {
                throw \Illuminate\Validation\ValidationException::withMessages(['XRF_Columnas' => 'Seleccione exactamente tres columnas diferentes.']);
            }
            try {
    ...
    public function FOR_PIMP_05_B_01_store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'XRF_Columnas.*' => 'integer|distinct|between:1,7',
