...
namespace App\Http\Controllers\TICS;
...
class TICSController extends Controller
{
    ...
    public function storeTICS(Request $request)
    {
            ...
            if ($existsNo_Economico && $existsSerie)
            {
                return redirect()->back()->withErrors([
                    'ID' => 'El No economico ya existe en la base de datos.',
        ...
        /* Tabla General_EyC */
            ...
            if($request->input('ID')==null)
            {
                ...
                $general->No_economico = $request->input('ID');
            }
     ...
     */
    public function show(TICS $tICS)
    {
        //
    }
     ...
     */
    public function edit(TICS $tICS)
    {
        //
    }
     ...
     */
    public function updateTICS(Request $request, $id)
    {
        $request->validate([
            'Nombre_E_P_BP' => 'required|string|max:255',
            'ID' => 'required|string|max:255',
     ...
     */
    public function destroy(TICS $tICS)
    {
        //
    }
}
