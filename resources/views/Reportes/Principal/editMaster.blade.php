...
@section('content')
    ...
    @elseif($Nombre_Formato == 'FOR-01-PRO-INS-14')
        @include('Reportes.INS.Edit.FOR-01-PRO-INS-14')
    @elseif($Nombre_Formato == 'FOR-01-PRO-INS-15')
        @include('Reportes.INS.Edit.FOR-01-PRO-INS-15')
    @elseif($Nombre_Formato == 'FOR-01-PRO-INS-16')
        @include('Reportes.INS.Edit.FOR-01-PRO-INS-16')
    @elseif($Nombre_Formato == 'FOR-01-PRO-INS-17')
        @include('Reportes.INS.Edit.FOR-01-PRO-INS-17')
    ...
    @elseif($Nombre_Formato == 'FOR-01-PRO-INS-19')
        @include('Reportes.INS.Edit.FOR-01-PRO-INS-19')
    @elseif($Nombre_Formato == 'FOR-01-PRO-INS-20')
        @include('Reportes.INS.Edit.FOR-01-PRO-INS-20')
    @elseif($Nombre_Formato == 'FOR-01-PRO-INS-21')
        @include('Reportes.INS.Edit.FOR-01-PRO-INS-21')
    @elseif($Nombre_Formato == 'FOR-01-PRO-INS-22') 
        @include('Reportes.INS.Edit.FOR-01-PRO-INS-22')
