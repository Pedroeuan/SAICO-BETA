...
<section class="content w-100">
    <div class="card w-100 p-3">
        <div class="card-body w-100">
            <form id="FOR-PINS-19-01" action="{{ route('Reportes_FOR_PINS_19_01.update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                                                ...
                                                @foreach ($bloque as $item)
                                                    ...
                                                    @if ($item['tipo'] == 'fila')
                                                        <tr data-titulo="{{ $titleId }}">
                                                            ...
                                                            <td><input type="text" class="form-control" name="junta[{{ $titleId }}][]" value="{{ $item['data']['junta'] }}"></td>
                                                            <td><input type="text" class="form-control" name="lado[{{ $titleId }}][]" value="{{ $item['data']['lado'] }}"></td>
                                                            ...
                                                            <td><input type="text" class="form-control" name="long[{{ $titleId }}][]" value="{{ $item['data']['long'] }}"></td>
                                                            ...
                                                            <td><input type="text" class="form-control" name="archivo[{{ $titleId }}][]" value="{{ $item['data']['archivo'] }}"></td>
                                                            <td><input type="text" class="form-control" name="long_ins[{{ $titleId }}][]" value="{{ $item['data']['long_ins'] }}"></td>
