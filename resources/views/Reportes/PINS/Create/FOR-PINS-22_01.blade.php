                ...
                <section class="content w-100">
                    <div class="card w-100 p-3">
                        <div class="card-body w-100">
                            <form id="FOR-PINS-22_01" action="{{route('Reportes_FOR_PINS_22_01.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                ...
                                <!-- check btton -->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control  is-waning" id="inputSuccess" name="Detalles_Generales[Serie]" placeholder="Ejemplo: OT-03 INGENIERÍA, PROCURA, CONSTRUCCIÓN DE UN OLEOGASODUCTO . . . .">{{old('Detalles_Generales.Serie')}}</textarea>
                                            @error('Serie')
                                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm @error('Fabricante') is-invalid @enderror" name="Detalles_Generales[Fabricante]"  placeholder="Ejemplo:" value="{{old('Detalles_Generales.Fabricante')}}">
                                            @error('Fabricante')
                                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm @error('Numero_Tubos') is-invalid @enderror" name="Detalles_Generales[Numero_Tubos]"  placeholder="Ejemplo:  " value="{{old('Detalles_Generales.Numero_Tubos')}}">
                                            @error('Numero_Tubos')
                                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm @error('Diametro') is-invalid @enderror" name="Detalles_Generales[Diametro]"  placeholder="Ejemplo:  " value="{{old('Detalles_Generales.Diametro')}}">
                                            @error('Diametro')
                                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm @error('Año_Fabricacion') is-invalid @enderror" name="Detalles_Generales[Año_Fabricacion]"  placeholder="Ejemplo:  " value="{{old('Detalles_Generales.Año_Fabricacion')}}">
                                    ...
                                    <div class="col-sm-50 d-flex justify-content-center">
                                        <div class="form-group text-center">
                                            ...
                                            <input type="hidden" name="Datos_Equipo[ID_BP]" id="IDInputA" value="{{ old('Datos_Equipo.ID_BP') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MARCA:</label>
                                            <input type="text" class="form-control  inputForm" id="marcaInputA" name="Datos_Equipo[MARCA_BP]" placeholder="" value="{{old('Datos_Equipo.MARCA_BP')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MODELO:</label>
                                            <input type="text" class="form-control  inputForm" id="modeloInputA" name="Datos_Equipo[MODELO_BP]" placeholder="" value="{{old('Datos_Equipo.MODELO_BP')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">N.S:</label>
                                            <input type="text" class="form-control  inputForm" id="nsInputA" name="Datos_Equipo[NS_BP]" placeholder="" value="{{old('Datos_Equipo.NS_BP')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[FREC_BP]" placeholder="" value="{{old('Datos_Equipo.FREC_BP')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="form-group">
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[CER_CALIBRACION]" placeholder="" value="{{old('Datos_Equipo.CER_CALIBRACION')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="form-group">
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[VIG_CALIBRACION]" placeholder="" value="{{old('Datos_Equipo.VIG_CALIBRACION')}}">
                                        </div>
                                    </div>
...
<script>
    ...
    function restoreData() {//-----------------------------------------------------------Reemplazar todo el resotedara
        ...
        const placeholders = { //CONFIGURAR CAMPOS DE ACUERDO A LOS PLACEHOLDERS DE CADA INPUT
            ...
            fase: 'Fase',
            ganancia: 'Ganancia',
            alcanse_inspeccion: 'Alcanse de Inspección',
            canal: 'Canal',
            inspeccion: '%Insp.',
            obstruccion: '%Obstru.',
            fila: 'Fila',
            ...
            longitud_franja: 'Longitud de la Franja',
...
function verificarYAgregarLongitud() {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const form = document.getElementById('FOR-PINS-22_01');
        if (!form) return;

        form.querySelectorAll('input:not([type="file"]), textarea, select').forEach(function (el) {
            el.addEventListener('input', function () {
                if (el.closest('#dynamicTable')) return; // Ignora inputs de la tabla
                localStorage.setItem('FOR-PINS-22_01_' + el.name, el.value);
            });
        });
        ...
        form.querySelectorAll('input:not([type="file"]), textarea, select').forEach(function (el) {
            if (!el.value) {
                const value = localStorage.getItem('FOR-PINS-22_01_' + el.name);
        ...
        form.addEventListener('submit', function () {
            form.querySelectorAll('input:not([type="file"]), textarea, select').forEach(function (el) {
                localStorage.removeItem('FOR-PINS-22_01_' + el.name);
