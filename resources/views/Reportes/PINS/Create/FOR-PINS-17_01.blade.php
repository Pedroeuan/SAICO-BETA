...
<section class="content w-100">
    <div class="card w-100 p-3">
        <div class="card-body w-100">
            <form id="FOR-PINS-17_01" action="{{route('Reportes_FOR_PINS_17_01.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div style="margin-bottom: 2px;"></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm @error('Equipo') is-invalid @enderror" name="Detalles_Generales[Equipo]"  placeholder="Ejemplo:" value="{{old('Detalles_Generales.Equipo')}}">
                            @error('Equipo')
                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm @error('Ubicacion') is-invalid @enderror" name="Detalles_Generales[Ubicacion]"  placeholder="Ejemplo:  " value="{{old('Detalles_Generales.Ubicacion')}}">
                            @error('Ubicacion')
                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm @error('H_Inspeccion') is-invalid @enderror" name="Detalles_Generales[H_Inspeccion]"  placeholder="Ejemplo:  18:00 HRS" value="{{old('Detalles_Generales.H_Inspeccion')}}">
                            @error('H_Inspeccion')
                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm @error('Stndr_refe') is-invalid @enderror" name="Detalles_Generales[Stndr_refe]"  placeholder="Ejemplo:  " value="{{old('Detalles_Generales.Stndr_refe')}}">
                            @error('Stndr_refe')
                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm" id="fechaInputE" name="Datos_Equipo[FEC_CAL]" placeholder="" value="{{old('Datos_Equipo.FEC_CAL')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm" id="certificadoInputE" name="Datos_Equipo[CER_POR]" placeholder="" value="{{old('Datos_Equipo.CER_POR')}}">
                        </div>
                    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const form = document.getElementById('FOR-PINS-17_01');
        if (!form) return;

        form.querySelectorAll('input:not([type="file"]), textarea, select').forEach(function (el) {
            el.addEventListener('input', function () {
                if (el.closest('#dynamicTable')) return; // Ignora inputs de la tabla
                localStorage.setItem('FOR-PINS-17_01_' + el.name, el.value);
            });
        ...
        form.querySelectorAll('input:not([type="file"]), textarea, select').forEach(function (el) {
            if (!el.value) {
                const value = localStorage.getItem('FOR-PINS-17_01_' + el.name);
        ...
        form.addEventListener('submit', function () {
            form.querySelectorAll('input:not([type="file"]), textarea, select').forEach(function (el) {
                localStorage.removeItem('FOR-PINS-17_01_' + el.name);
                //localStorage.clear();
            });
        });
    });
