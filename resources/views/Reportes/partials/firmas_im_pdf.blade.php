<style>
    ...
    .firmas-im td { text-align: center; vertical-align: top; padding: 0 12px; font-size: 8px; }
    .firmas-im .firma-titulo { font-weight: bold; line-height: 11px; min-height: 8px; }
    ...
    .firmas-im .firma-dato { margin-top: 2px; line-height: 10px; font-weight: bold; }
    ...
    .firmas-im .firma-separacion-cuatro td { padding-top: 16px; }
</style>
