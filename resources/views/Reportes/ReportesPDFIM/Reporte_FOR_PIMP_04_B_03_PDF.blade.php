...
<table class="tablaGenerales">
    ...
    <tbody>
        <tr>
            ...
            <th class="etiquetaGeneralCentrada">REPORT No.:</th>
            <td class="line" colspan="2">
        ...
        <tr>
            ...
            <th class="etiquetaGeneralCentrada">CONTRACT:</th>
            <td class="line">
        ...
        <tr>
            ...
            <th class="etiquetaGeneralCentrada">TRACEABILITY:</th>
            <td class="line">
        ...
        <tr>
            ...
            <th class="etiquetaGeneralCentrada">EVALUATION CRITERIA:</th>
            <td class="line" colspan="2">
...
<table class="grid">
    <thead>
        <tr class="section-title">
            <th colspan="6">HARDNESS TEST</th>
        </tr>
        <tr>
            <th colspan="6">EQUIPMENT DATA</th>
        </tr>
        <tr>
...
<table class="grid hardness-values">
    ...
    <thead>
        <tr class="section-title">
            <th colspan="7">HARDNESS VALUES MEASURED IN {{ $Datos_Equipo['ESCALA_DUREZA'] ?? 'XXX' }}</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            ...
            <td>{{ $valor }}</td>
            @endforeach
            <th class="label" rowspan="2">AVERAGE</th>
...
<table class="grid">
    <thead>
        <tr class="section-title">
            <th colspan="5">MATERIAL DATA OBTAINED</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <th class="label">MATERIAL DESCRIPTION</th>
            <th class="label">BRINELL HARDNESS</th>
            <th class="label">TENSILE STRENGTH (KSI)</th>
            <th class="label">YIELD STRENGTH (KSI)</th>
            <th class="label">GRAIN SIZE</th>
        </tr>
        <tr>
...
<table class="grid">
    <thead>
        <tr class="section-title">
            <th colspan="5">REFERENCE STANDARD DATA</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <th class="label">REFERENCE STANDARD</th>
            <th class="label">BRINELL HARDNESS, MAX.</th>
            <th class="label">MINIMUM TENSILE STRENGTH (KSI)</th>
            <th class="label">SPECIFIED YIELD STRENGTH (KSI)</th>
            <th class="label">MAXIMUM TENSILE STRENGTH (KSI)</th>
        </tr>
        <tr>
...
<table class="grid">
    <thead>
        <tr class="section-title">
            <th colspan="6">CHEMICAL ANALYSIS</th>
        </tr>
        <tr>
            <th colspan="6">EQUIPMENT DATA</th>
        </tr>
...
@php
    $ordinalesDisparoPdf = [1 => '1st', 2 => '2nd', 3 => '3rd'];
                ...
                <td class="shot-cell">
                    @if($celdaDisparo === 'tabla_quimica')
                        <table class="chemical">
                            ...
                            <thead>
                                <tr>
                                    <th colspan="3">THEORETICAL CHEMICAL COMPOSITION<br>VS<br>AVERAGE VALUES OF THE ANALYZED PART</th>
                                </tr>
                                <tr>
                                    <th>ELEMENT</th>
                                    <th>AVERAGE VALUES OF THE ANALYZED PART</th>
                                    <th>THEORETICAL CHEMICAL COMPOSITION</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    @else
                        <div class="shot-title">{{ $ordinalesDisparoPdf[$celdaDisparo] }} SHOT<br>VALUES OBTAINED FROM THE ANALYZED PART</div>
                        <table class="shot-images"><tr>
                            @for($indiceImagen = 0; $indiceImagen < 2; $indiceImagen++)
                                <td><div class="shot-image">
                                    @if(!empty($Disparos[$celdaDisparo][$indiceImagen]))<img src="{{ $Disparos[$celdaDisparo][$indiceImagen] }}" alt="Shot {{ $celdaDisparo }}">@endif
                                </div>
                            </td>
                            @endfor
                        </tr>
