...
<section class="content w-100">
    <div class="card w-100 p-3">
        <div class="card-body w-100">
            <form id="FOR-PIMP-03_B_01" action="{{route('Reportes_FOR_PIMP_03_B_01.update', $id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div style="margin-bottom: 2px;"></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            {{-- Proyecto alimenta la fila bilingüe CONTRATO/Contract del PDF del formato 03. --}}
                            ...
                            <textarea id="proyectoContrato"
                                ...
                                placeholder="Ingrese el contrato o descripción del proyecto">{{ old('Detalles_Generales.Proyecto', $Detalles_Generales['Proyecto'] ?? '') }}</textarea>
