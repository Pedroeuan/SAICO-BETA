            ...
            <form id="FOR-PIMP-04_02" action="{{route('Reportes_FOR_PIMP_04_02.update', $id)}}" method="post" enctype="multipart/form-data">
                ...
                <div style="margin-bottom: 2px;"></div>
                    ...
                    @php
                        ...
                        $columnasXrfSeleccionadas = old('XRF_Columnas', $normaHistoricaXrf['Columnas_Seleccionadas'] ?? [1, 2, 3]);
                    @endphp
                    ...
                    <div class="col-12">
                        <div class="form-group border rounded p-3 bg-light">
                            ...
                            <small class="form-text text-muted">
                                Suba un solo PDF y seleccione exactamente tres columnas. Al cargar uno nuevo se reemplaza el análisis XRF anterior.
                            </small>
