<!DOCTYPE html>
        ...
        <head>
            <meta charset="UTF-8">
            <title>FORMATO FOR-PINS-17/01</title>
            <style>
                @page {
                        margin: 
                        3.0cm /* superior */
                ...
                header {
                        position: fixed;
                        top: -25px; /* Ajusta para que no interfiera con el margen de la página */
                        left: 0;
                        right: 0;
        ...
        <div class="page">
                ...
                <table class="tablaheader">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 90%;">FOR-PINS-17/01</th>
                    ...
                    <tbody>
                        <tr>
                            <th rowspan="2" style="font-size: 8pt;">INSPECCIÓN CON TERMOGRAFÍA INFRARROJA</th>
                            <th>Versión</th>
                            <th>1</th>
                        </tr>
                        <tr>
            ...
            <footer>
                <p style="text-align: left;">FOR-PINS-17/01</p>
            </footer>
                ...
                <table class="tablaheader">
                    <thead>
                        <tr>
                            <th style="width: 500%;">FORMATO</th>
                            <th style="width: 60%;">Código:</th>
                            <th style="width: 80%;">FOR-PINS-17/01</th>
                            <th rowspan="3" style="width: 80%;"><img  src="{{ $Logo }}" alt="Logo" style="width: 55%; height: auto;"></th>
                        </tr>
                    </thead>
