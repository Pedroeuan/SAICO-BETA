                    ...
                    <div class="card w-100">
                        <div class="card-body row w-100">
                            <form id="FOR-02-PRO-INS-10" action="{{route('Reportes_FOR_02_PRO_INS_10.store')}}" method="post" enctype="multipart/form-data">
                                @csrf 
                                <div class="d-flex justify-content-center align-items-center p-2 bg-white text-dark rounded"><strong>INFORME DE INSPECCIÓN DE SOLDADURAS CON ULTRASONIDO, DE ACUERDO CON AWS D1.1 PARA COMPONENTES NO TUBULARES</strong></div>
                                <div class="row">
    ...
    $(document).ready(function() {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control" name="no_aceptacion[]" placeholder="No. Indicación"></td>
                    <td><input type="text" class="form-control" name="no_serie[]" placeholder="Angulo de Inspección"></td>
                    <td><input type="text" class="form-control" name="no_colada[]" placeholder="CARA"></td>
                    <td><input type="text" class="form-control" name="tnominal[]" placeholder="PIERNA"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="A"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="B"></td>
                    <td><input type="text" class="form-control" name="tipo_indicacion[]" placeholder="C"></td>
                    <td><input type="text" class="form-control" name="tipo_indicacion[]" placeholder="D"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Longitud"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Distancia Angular"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Profundidad A"></td>

                    <td><input type="text" class="form-control" name="la[]" placeholder="X" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Y" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Discontinuidad"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Evaluación"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Observaciones"></td>
