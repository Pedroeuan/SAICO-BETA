                    ...
                    <div class="card w-100">
                        <div class="card-body row w-100">
                            <form id="FOR-02-PRO-INS-10" action="{{route('Reportes_FOR_02_PRO_INS_10.store')}}" method="post" enctype="multipart/form-data">
                                @csrf 
                                <div class="d-flex justify-content-center align-items-center p-2 bg-white text-dark rounded"><strong>INFORME DE DETECCIÓN DE DISCONTINUIDADES CON CORRIENTES DE EDDY</strong></div>
                                <div class="row">
                                ...
                                <div style="margin-bottom: 2px;"></div>
                                    ...
                                    <!--***************************************** FIN DATOS Y AJUSTES DEL EQUIPO *****************************************-->
                                    <!--***************************************** INICIO RESULTADOS *****************************************-->
                                    ...
                                    <table id="dynamicTable" class="table table-bordered table-striped dt-responsive tablas w-100">
                                        <thead>
                                            <tr>
                                                <th colspan="2">DATOS DE LA INSPECCIÓN</th>
                                                <th colspan="5">DATOS DE LA INDICACIÓN</th>
                                                <th colspan="2">ÁREA INPECCIONADA</th>
    ...
    $(document).ready(function() {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control" name="no_aceptacion[]" placeholder="Zona de Barrido" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_serie[]" placeholder="No. Indicación" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="no_colada[]" placeholder="Tipo de Indicación" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="tnominal[]" placeholder="LA" style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="LC" style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="H.T." style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="LARGO" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="ANCHO" style="width: 70px;"></td>
                    ...
                    <td><input type="text" class="form-control" name="la[]" placeholder="Observaciones" style="width: 130px;"></td>
