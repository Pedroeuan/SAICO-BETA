                    ...
                    <div class="card w-100">
                        <div class="card-body row w-100">
                            <form id="FOR-02-PRO-INS-10" action="{{route('Reportes_FOR_02_PRO_INS_10.store')}}" method="post" enctype="multipart/form-data">
                                @csrf 
                                <div class="d-flex justify-content-center align-items-center p-2 bg-white text-dark rounded"><strong>INFORME DE INSPECCIÓN ULTRASÓNICA CON HAZ ANGULAR</strong></div>
                                <div class="row">
    ...
    $(document).ready(function() {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control" name="no_aceptacion[]" placeholder="No. de Junta" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_serie[]" placeholder="Lado A" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="no_colada[]" placeholder="Lado B" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="tnominal[]" placeholder="0" style="width: 80px;"></td>
                    ...
                    <td><input type="text" class="form-control" name="la[]" placeholder="A (°)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="G (dB)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="NR (%)" style="width: 95px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="NI (%)" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="X" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="Y" style="width: 70px;"></td>

                    <td><input type="text" class="form-control" name="la[]" placeholder="Horario Técnico" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="No. de Pierna" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="S" style="width: 95px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="L" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="D" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="tmin" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Evaluación" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="Fotos No." style="width: 95px;"></td>
