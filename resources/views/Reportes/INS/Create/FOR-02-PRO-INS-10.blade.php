...
<script>
    ...
    $(document).ready(function() {
        function actualizarInputsE() {
            ...
            // Si hay solo una opción en el select, forzar la selección y disparar el evento
            if ($('#equiposSelect option').length === 1) {
            $('#equiposSelect option:first').prop('selected', true);
            actualizarInputsE();
            }
    ...
    $(document).ready(function() {
        function actualizarInputsA() {
            ...
            // Si hay solo una opción en el select, forzar la selección y disparar el evento
            if ($('#accesoriosSelect option').length === 1) {
            $('#accesoriosSelect option:first').prop('selected', true);
            actualizarInputsA();
            }
    ...
    $(document).ready(function() {
            ...
            // Si hay solo una opción en el select, forzar la selección y disparar el evento
            if ($('#blockyprobetaSelect option').length === 1) {
            $('#blockyprobetaSelect option:first').prop('selected', true);
            actualizarInputsbyp();
            }
