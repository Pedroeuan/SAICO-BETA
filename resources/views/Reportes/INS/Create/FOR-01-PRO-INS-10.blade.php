                    ...
                    <div class="card w-100">
                        <div class="card-body row w-100">
                            <form id="FOR-02-PRO-INS-10" action="{{route('Reportes_FOR_02_PRO_INS_10.store')}}" method="post" enctype="multipart/form-data">
                                @csrf 
                                <div class="d-flex justify-content-center align-items-center p-2 bg-white text-dark rounded"><strong>INFORME DE INSPECCIÓN ULTRASÓNICA CON HAZ RECTO PARA METAL BASE</strong></div>
                                <div class="row">
                                    ...
                                    <table id="dynamicTable" class="table table-bordered table-striped dt-responsive tablas w-100">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>S.C. ó Lado de Referencia</th>
                                                <th>LA</th>
                                                <th>LC</th>
                                                <th>tmin</th>
                                                <th>d</th>
                                                <th>ta</th>
                                                <th>Perdida de Material (%)</th>
                                                <th>Fotos No.</th>
                                                <th>Observaciones</th>
    ...
    $(document).ready(function() {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control" name="no_aceptacion[]" placeholder="Elemento" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_serie[]" placeholder="Nivel" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="no_colada[]" placeholder="0nom" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="tnominal[]" placeholder="0ext" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="No. Indicación" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="Tipo de Indicación" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="G (dB)" style="width: 75px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="NR (%)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="NI (%)" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="DNR" style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="Horario Técnico" style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="S.C." style="width: 80px;"></td>

                    <td><input type="text" class="form-control" name="la[]" placeholder="LA" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="LC" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="tmin" style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="d" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="ta" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="Perdida de Material (%)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="Fotos No." style="width: 90px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="Observaciones" style="width: 130px;"></td>
