...
<script>
    /*Prevenir el Enter*/
    document.getElementById('FOR-01-PRO-INS-09').addEventListener('keydown', function(event) {
            if (event.key === 'Enter') {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    ...
                    <td><input type="text" class="form-control" name="angulo_inspeccion[]" placeholder="Angulo de Inspección" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="pierna[]" placeholder="Pierna" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="nivel_referencia[]" placeholder="Nivel de Referencia" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="nivel_indicacion[]" placeholder="Nivel Indicación" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="distancia_angular[]" placeholder="Distancia Angular" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="profundidad[]" placeholder="Profundidad" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="longitud[]" placeholder="Longitud" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="evaluacion[]" placeholder="Evaluación" style="width: 55px;"></td>
                    ...
                    <td><input type="text" class="form-control" name="observaciones[]" placeholder="Observaciones" style="width: 60px;"></td>
