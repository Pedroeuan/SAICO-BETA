                    ...
                    <div class="card w-100">
                        <div class="card-body row w-100">
                            <form id="FOR-02-PRO-INS-10" action="{{route('Reportes_FOR_02_PRO_INS_10.store')}}" method="post" enctype="multipart/form-data">
                                @csrf 
                                <div class="d-flex justify-content-center align-items-center p-2 bg-white text-dark rounded"><strong>INFORME DE INSPECCIÓN DE SOLDADURAS CON ULTRASONIDO, DE ACUERDO CON API 1104</strong></div>
                                <div class="row">
    ...
    $(document).ready(function() {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control" name="no_aceptacion[]" placeholder="No. de Indicación" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="no_serie[]" placeholder="Angulo de Inspección" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="no_colada[]" placeholder="Pierna" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="tnominal[]" placeholder="Nivel de Referencia" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="Nivel Indicación" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="Distancia Angular" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Profundidad" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="Longitud" style="width: 50px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="Evaluación" style="width: 55px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="X" style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="Y" style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="Observaciones" style="width: 60px;"></td>
