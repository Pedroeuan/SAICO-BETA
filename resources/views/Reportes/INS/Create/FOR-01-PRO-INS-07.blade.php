                    ...
                    <div class="card w-100">
                        <div class="card-body row w-100">
                            <form id="FOR-02-PRO-INS-10" action="{{route('Reportes_FOR_02_PRO_INS_10.store')}}" method="post" enctype="multipart/form-data">
                                @csrf 
                                <div class="d-flex justify-content-center align-items-center p-2 bg-white text-dark rounded"><strong>INFORME DE INSPECCIÓN CON ULTRASONIDO POR ARREGLO DE FASES</strong></div>
                                <div class="row">
    ...
    $(document).ready(function() {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control" name="no_aceptacion[]" placeholder="No. de Indicación" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_serie[]" placeholder="Ang (°)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="no_colada[]" placeholder="NR (%)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="tnominal[]" placeholder="NI (%)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="LA (in)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="LC (in)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Distancia a Zapata" style="width: 160px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="SA (in)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="DA (prof.)" style="width: 95px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="HT" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="Evaluación" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="Fotos" style="width: 80px;"></td>
