                    ...
                    <div class="card w-100">
                        <div class="card-body row w-100">
                            <form id="FOR-02-PRO-INS-10" action="{{route('Reportes_FOR_02_PRO_INS_10.store')}}" method="post" enctype="multipart/form-data">
                                @csrf 
                                <div class="d-flex justify-content-center align-items-center p-2 bg-white text-dark rounded"><strong>INSPECCIÓN CON TERMOGRAFÍA INFRARROJA A TABLEROS</strong></div>
                                <div class="row">
                                ...
                                <div style="margin-bottom: 2px;"></div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">TEM. AMBIENTAL:</label>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">TEM. REFLEJADA:</label>
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[RECHAZO]" placeholder="" value="{{old('Datos_Equipo.RECHAZO')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">ÁNGULO DE TEMPERATURA:</label>
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[RECHAZO]" placeholder="" value="{{old('Datos_Equipo.RECHAZO')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-center align-items-center p-2 bg-primary text-white rounded">INTRODUCCIÓN</div>
    ...
    $(document).ready(function() {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control" name="no_aceptacion[]" placeholder="Tipo de Indicación" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_serie[]" placeholder="L (PLG)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="no_colada[]" placeholder="A (PLG)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="tnominal[]" placeholder="ALTURA (PLG)" style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="X" style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="Y" style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="DA (PROF)" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="PA" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="SA" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Tmin" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Datos del Archivo (Escaneo)" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Evaluación" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Fotos" style="width: 70px;"></td>
