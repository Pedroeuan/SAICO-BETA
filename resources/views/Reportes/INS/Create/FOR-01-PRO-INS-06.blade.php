                    ...
                    <div class="card w-100">
                        <div class="card-body row w-100">
                            <form id="FOR-02-PRO-INS-10" action="{{route('Reportes_FOR_02_PRO_INS_10.store')}}" method="post" enctype="multipart/form-data">
                                @csrf 
                                <div class="d-flex justify-content-center align-items-center p-2 bg-white text-dark rounded"><strong>INFORME DE MEDICION DE ESPESORES DE PARED EN LA TUBERIA Y ELEMENTOS ESTRUCTURALES</strong></div>
                                <div class="row">
    ...
    $(document).ready(function() {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control" name="no_aceptacion[]" placeholder="Descripción del Elemento" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_serie[]" placeholder="0nom" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_colada[]" placeholder="0ext" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="tnominal[]" placeholder="Nivel" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="12:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="01:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="01:30" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="02:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="03:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="04:00" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="04:30" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="05:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="06:00" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="07:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="07:30" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="08:00" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="09:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="10:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="10:30" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="diametro[]" placeholder="11:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="no_ind[]" placeholder="Tmin" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Tmax" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="Tprom" style="width: 150px;"></td>
