...
@section('title', 'FOR-01-PRO-INS-07')
                ...
                <section class="content w-100">
                    <div class="card w-100">
                        <div class="card-body row w-100">
                            <form id="FOR-01-PRO-INS-07" action="{{ route('Reportes_FOR_01_PRO_INS_07.update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div style="margin-bottom: 2px;"></div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm @error('Cliente') is-invalid @enderror" name="Detalles_Generales[Cliente]"  placeholder="Ejemplo: PERMADUCTO S.A DE C.V." value="{{old('Detalles_Generales.Cliente', $Detalles_Generales['ClienteCliente'] ?? '')}}">
                                            @error('Cliente')
                                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MARCA:</label>
                                            <input type="text" class="form-control  inputForm" id="marcaInputE" name="Datos_Equipo[MARCA_SONDA1]" placeholder="" value="{{old('Datos_Equipo.MARCA_SONDA1', $Datos_Equipo['MARCA_SONDA1'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MODELO:</label>
                                            <input type="text" class="form-control  inputForm" id="modeloInputE" name="Datos_Equipo[MODELO_SONDA1]" placeholder="" value="{{old('Datos_Equipo.MODELO_SONDA1', $Datos_Equipo['MODELO_SONDA1'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">N.S:</label>
                                            <input type="text" class="form-control  inputForm" id="nsInputE" name="Datos_Equipo[N_S_SONDA1]" placeholder="" value="{{old('Datos_Equipo.N_S_SONDA1', $Datos_Equipo['N_S_SONDA1'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" id="nsInputE" name="Datos_Equipo[FRECUENCIA_SONDA1]" placeholder="" value="{{old('Datos_Equipo.FRECUENCIA_SONDA1', $Datos_Equipo['FRECUENCIA_SONDA1'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-50 d-flex justify-content-center">
                                        <div class="form-group text-center">
                                            ...
                                            <option value="" selected disabled>Seleccione una Sonda</option>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MARCA:</label>
                                            <input type="text" class="form-control  inputForm" id="marcaInputbyp" name="Datos_Equipo[MARCA_SONDA2]" placeholder="" value="{{old('Datos_Equipo.MARCA_SONDA2', $Datos_Equipo['MARCA_SONDA2'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MODELO:</label>
                                            <input type="text" class="form-control  inputForm" id="modeloInputbyp" name="Datos_Equipo[MODELO_SONDA2]" placeholder="" value="{{old('Datos_Equipo.MODELO_SONDA2', $Datos_Equipo['MODELO_SONDA2'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">N.S:</label>
                                            <input type="text" class="form-control  inputForm" id="nsInputbyp" name="Datos_Equipo[N_S_SONDA2]" placeholder="" value="{{old('Datos_Equipo.N_S_SONDA2', $Datos_Equipo['N_S_SONDA2'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">FRECC:</label>
                                            <input type="text" class="form-control  inputForm" id="nsInputE" name="Datos_Equipo[FRECUENCIA_SONDA2]" placeholder="" value="{{old('Datos_Equipo.FRECUENCIA_SONDA2', $Datos_Equipo['FRECUENCIA_SONDA2'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MARCA:</label>
                                            <input type="text" class="form-control  inputForm" id="marcaInputbyp" name="Datos_Equipo[MARCA_BLOCK_SENSIBILIDAD]" placeholder="" value="{{old('Datos_Equipo.MARCA_BLOCK_SENSIBILIDAD', $Datos_Equipo['MARCA_BLOCK_SENSIBILIDAD'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MODELO:</label>
                                            <input type="text" class="form-control  inputForm" id="modeloInputbyp" name="Datos_Equipo[MODELO_BLOCK_SENSIBILIDAD]" placeholder="" value="{{old('Datos_Equipo.MODELO_BLOCK_SENSIBILIDAD', $Datos_Equipo['MODELO_BLOCK_SENSIBILIDAD'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">N.S:</label>
                                            <input type="text" class="form-control  inputForm" id="nsInputbyp" name="Datos_Equipo[N_S_BLOCK_SENSIBILIDAD]" placeholder="" value="{{old('Datos_Equipo.N_S_BLOCK_SENSIBILIDAD', $Datos_Equipo['N_S_BLOCK_SENSIBILIDAD'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MARCA:</label>
                                            <input type="text" class="form-control  inputForm" id="marcaInputbyp" name="Datos_Equipo[MARCA_BLOCK_DISTANCIA]" placeholder="" value="{{old('Datos_Equipo.MARCA_BLOCK_DISTANCIA', $Datos_Equipo['MARCA_BLOCK_DISTANCIA'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MODELO:</label>
                                            <input type="text" class="form-control  inputForm" id="modeloInputbyp" name="Datos_Equipo[MODELO_BLOCK_DISTANCIA]" placeholder="" value="{{old('Datos_Equipo.MODELO_BLOCK_DISTANCIA', $Datos_Equipo['MODELO_BLOCK_DISTANCIA'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">N.S:</label>
                                            <input type="text" class="form-control  inputForm" id="nsInputbyp" name="Datos_Equipo[N_S_BLOCK_DISTANCIA]" placeholder="" value="{{old('Datos_Equipo.N_S_BLOCK_DISTANCIA', $Datos_Equipo['N_S_BLOCK_DISTANCIA'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[TEMPERATURA]" placeholder="" value="{{old('Datos_Equipo.TEMPERATURA', $Datos_Equipo['TEMPERATURA'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <table id="dynamicTable" class="table table-bordered table-striped dt-responsive tablas w-100">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" name="no_indicacion[]" value="{{ $junta['no_indicacion'] ?? ''}}" placeholder="Elemento" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="angulo[]" value="{{ $junta['angulo'] ?? '' }}" placeholder="0nom" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="nr[]" value="{{ $junta['nr'] ?? '' }}" placeholder="0ext" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="ni[]" value="{{ $junta['ni'] ?? '' }}" placeholder="Nivel" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="la[]" value="{{ $junta['la'] ?? '' }}" placeholder="12:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="lc[]" value="{{ $junta['lc'] ?? '' }}" placeholder="01:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="distancia_frente_zapata[]" value="{{ $junta['distancia_frente_zapata'] ?? ''}}" placeholder="01:30" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="sa[]" value="{{ $junta['sa'] ?? '' }}" placeholder="02:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="da[]" value="{{ $junta['da'] ?? '' }}" placeholder="03:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="ht[]" value="{{ $junta['ht'] ?? '' }}" placeholder="04:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="evaluacion[]" value="{{ $junta['evaluacion'] ?? '' }}" placeholder="04:30" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="fotos[]" value="{{ $junta['fotos'] ?? '' }}" placeholder="05:00" style="width: 100px;"></td>
...
<script>
    /*Prevenir el Enter*/
    document.getElementById('FOR-01-PRO-INS-07').addEventListener('keydown', function(event) {
            if (event.key === 'Enter') {
    ...
    $(document).ready(function() {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control" name="no_indicacion[]" placeholder="No. de Indicación" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="angulo[]" placeholder="Ang (°)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="nr[]" placeholder="NR (%)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="ni[]" placeholder="NI (%)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="la[]" placeholder="LA (in)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="lc[]" placeholder="LC (in)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="distancia_frente_zapata[]" placeholder="Distancia a Zapata" style="width: 160px;"></td>
                    <td><input type="text" class="form-control" name="sa[]" placeholder="SA (in)" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="da[]" placeholder="DA (prof.)" style="width: 95px;"></td>
                    <td><input type="text" class="form-control" name="ht[]" placeholder="HT" style="width: 70px;"></td>
                    <td><input type="text" class="form-control" name="evaluacion[]" placeholder="Evaluación" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="fotos[]" placeholder="Fotos" style="width: 80px;"></td>
                    <td><button type="button" class="btn btn-danger btnEliminar"><i class="fa fa-times" aria-hidden="true"></i></button></td>
                    </tr>`;
