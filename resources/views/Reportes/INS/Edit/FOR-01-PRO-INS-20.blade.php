...
@section('title', 'FOR-01-PRO-INS-20')
...
<section class="content w-100">
    <div class="card w-100 p-3">
        <div class="card-body w-100">
            <form id="FOR-01-PRO-INS-20" action="{{ route('Reportes_FOR_01_PRO_INS_20.update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div style="margin-bottom: 2px;"></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm @error('tip_ais') is-invalid @enderror" name="Detalles_Generales[tip_ais]"  placeholder="Ejemplo:" value="{{old('Detalles_Generales.tip_ais', $Detalles_Generales['tip_ais'] ?? '')}}">
                            @error('tip_ais')
                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm @error('ins') is-invalid @enderror" name="Detalles_Generales[ins]"  placeholder="Ejemplo:  " value="{{old('Detalles_Generales.ins', $Detalles_Generales['ins'] ?? '')}}">
                            @error('ins')
                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm @error('Nom_pz') is-invalid @enderror" name="Detalles_Generales[Nom_pz]"  placeholder="Ejemplo:  " value="{{old('Detalles_Generales.Nom_pz', $Detalles_Generales['Nom_pz'] ?? '')}}">
                            @error('Nom_pz')
                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm @error('Trazabilidad') is-invalid @enderror" name="Detalles_Generales[Trazabilidad]"  placeholder="Ejemplo:  " value="{{old('Detalles_Generales.Trazabilidad', $Detalles_Generales['Trazabilidad'] ?? '')}}">
                            @error('Trazabilidad')
                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                            @enderror
                        </div>
