                            ...
                            <form id="FOR-01-PRO-INS-06" action="{{ route('Reportes_FOR_01_PRO_INS_06.update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div style="margin-bottom: 2px;"></div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MARCA:</label>
                                            <input type="text" class="form-control  inputForm" id="marcaInputT" name="Datos_Equipo[MARCA_TRANSDUCTOR]" placeholder="" value="{{old('Datos_Equipo.MARCA_TRANSDUCTOR', $Datos_Equipo['MARCA_TRANSDUCTOR'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">MODELO:</label>
                                            <input type="text" class="form-control  inputForm" id="modeloInputT" name="Datos_Equipo[MODELO_TRANSDUCTOR]" placeholder="" value="{{old('Datos_Equipo.MODELO_TRANSDUCTOR', $Datos_Equipo['MODELO_TRANSDUCTOR'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">N.S:</label>
                                            <input type="text" class="form-control  inputForm" id="nsInputT" name="Datos_Equipo[N_S_TRANSDUCTOR]" placeholder="" value="{{old('Datos_Equipo.N_S_TRANSDUCTOR', $Datos_Equipo['N_S_TRANSDUCTOR'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" id="frecuenciaInputT" name="Datos_Equipo[FRECUENCIA_TRANSDUCTOR]" placeholder="" value="{{old('Datos_Equipo.FRECUENCIA_TRANSDUCTOR', $Datos_Equipo['FRECUENCIA_TRANSDUCTOR'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[PRESION_OPERACION]" placeholder="" value="{{old('Datos_Equipo.PRESION_OPERACION', $Datos_Equipo['PRESION_OPERACION'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[PRESION_MAXIMA_OPERACION]" placeholder="" value="{{old('Datos_Equipo.PRESION_MAXIMA_OPERACION', $Datos_Equipo['PRESION_MAXIMA_OPERACION'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[TEMPERATURA_MAXIMA_OPERACION]" placeholder="" value="{{old('Datos_Equipo.TEMPERATURA_MAXIMA_OPERACION', $Datos_Equipo['TEMPERATURA_MAXIMA_OPERACION'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[ESTADO_PINTURA]" placeholder="" value="{{old('Datos_Equipo.ESTADO_PINTURA', $Datos_Equipo['ESTADO_PINTURA'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <table id="dynamicTable" class="table table-bordered table-striped dt-responsive tablas w-100">
                                        ...
                                        <thead>
                                            ...
                                            <tr id="inputRow">
                                                ...
                                                <th><input type="text" class="form-control default-input" data-column="22"></th>
                                                <th><input type="text" class="form-control default-input" data-column="23"></th>
                                                <th><input type="text" class="form-control default-input" data-column="24"></th>
                                            ...
                                            <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" name="elemento[]" value="{{ $junta['elemento'] ?? ''}}" placeholder="Elemento" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="0nom[]" value="{{ $junta['0nom'] ?? '' }}" placeholder="0nom" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="0ext[]" value="{{ $junta['0ext'] ?? '' }}" placeholder="0ext" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="nivel[]" value="{{ $junta['nivel'] ?? '' }}" placeholder="Nivel" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="12_00[]" value="{{ $junta['12_00'] ?? '' }}" placeholder="12:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="01_00[]" value="{{ $junta['01_00'] ?? '' }}" placeholder="01:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="01_30[]" value="{{ $junta['01_30'] ?? ''}}" placeholder="01:30" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="02_00[]" value="{{ $junta['02_00'] ?? '' }}" placeholder="02:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="03_00[]" value="{{ $junta['03_00'] ?? '' }}" placeholder="03:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="04_00[]" value="{{ $junta['04_00'] ?? '' }}" placeholder="04:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="04_30[]" value="{{ $junta['04_30'] ?? '' }}" placeholder="04:30" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="05_00[]" value="{{ $junta['05_00'] ?? '' }}" placeholder="05:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="06_00[]" value="{{ $junta['06_00'] ?? ''}}" placeholder="06:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="07_00[]" value="{{ $junta['07_00'] ?? '' }}" placeholder="07:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="07_30[]" value="{{ $junta['07_30'] ?? '' }}" placeholder="07:30" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="08_00[]" value="{{ $junta['08_00'] ?? '' }}" placeholder="08:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="09_00[]" value="{{ $junta['09_00'] ?? '' }}" placeholder="09:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="10_00[]" value="{{ $junta['10_00'] ?? '' }}" placeholder="10:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="10_30[]" value="{{ $junta['10_30'] ?? ''}}" placeholder="10:30" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="11_00[]" value="{{ $junta['11_00'] ?? '' }}" placeholder="11:00" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="tmin[]" value="{{ $junta['tmin'] ?? '' }}" placeholder="Tmin" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="tmax[]" value="{{ $junta['tmax'] ?? '' }}" placeholder="Tmax" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="tprom[]" value="{{ $junta['tprom'] ?? '' }}" placeholder="Tprom" style="width: 100px;"></td>
...
<script>
    /*Prevenir el Enter*/
    document.getElementById('FOR-01-PRO-INS-06').addEventListener('keydown', function(event) {
            if (event.key === 'Enter') {
    ...
    $(document).ready(function() {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    <td>${rowCount}</td>
                    <td><input type="text" class="form-control" name="elemento[]" placeholder="Descripción del Elemento" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="0nom[]" placeholder="0nom" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="0ext[]" placeholder="0ext" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="nivel[]" placeholder="Nivel" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="12_00[]" placeholder="12:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="01_00[]" placeholder="01:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="01_30[]" placeholder="01:30" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="02_00[]" placeholder="02:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="03_00[]" placeholder="03:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="04_00[]" placeholder="04:00" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="04_30[]" placeholder="04:30" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="05_00[]" placeholder="05:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="06_00[]" placeholder="06:00" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="07_00[]" placeholder="07:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="07_30[]" placeholder="07:30" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="08_00[]" placeholder="08:00" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="09_00[]" placeholder="09:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="10_00[]" placeholder="10:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="10_30[]" placeholder="10:30" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="11_00[]" placeholder="11:00" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="tmin[]" placeholder="Tmin" style="width: 100px;"></td>
                    <td><input type="text" class="form-control" name="tmax[]" placeholder="Tmax" style="width: 150px;"></td>
                    <td><input type="text" class="form-control" name="tprom[]" placeholder="Tprom" style="width: 150px;"></td>
