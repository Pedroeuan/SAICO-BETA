...
@section('title', 'FOR-01-PRO-INS-10')
    ...
    <section class="content w-100">
        <div class="card w-100 p-3">
            <div class="card-body w-100">
                <form id="FOR-02-PRO-INS-10" action="{{ route('Reportes_FOR_01_PRO_INS_10.update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div style="margin-bottom: 2px;"></div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  inputForm" name="Datos_Equipo[GANANCIA]" value="{{ old('Datos_Equipo.GANANCIA', $Datos_Equipo['GANANCIA'] ?? '') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  inputForm" name="Datos_Equipo[TEMP_MAX_OPE]" placeholder="" value="{{old('Datos_Equipo.TEMP_MAX_OPE', $Datos_Equipo['TEMP_MAX_OPE'] ?? '')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  inputForm" name="Datos_Equipo[EST_PINT]" placeholder="" value="{{old('Datos_Equipo.EST_PINT', $Datos_Equipo['EST_PINT'] ?? '')}}">
                            </div>
                        </div>
                        ...
                        <table id="dynamicTable" class="table table-bordered table-striped dt-responsive tablas w-100">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="align-middle">G (dB)</th>
                                    <th class="align-middle">NR (%)</th>
                                    <th class="align-middle">NI (%)</th>
                                    <th class="align-middle">DNR</th>
                                    <th class="align-middle">Horario Técnico</th>
                                    <th class="align-middle">S.C. ó Lado de Referencia</th>
                                    ...
                                    <th class="align-middle">Perdida de Material (%)</th>
                                    <th class="align-middle">Fotos No.</th>
                                ...
                                <tr id="inputRow">
                                    ...
                                    <th><input type="text" class="form-control default-input" data-column="8" style="width: 75px;"></th>
                                    <th><input type="text" class="form-control default-input" data-column="9" style="width: 80px;"></th>
                                    <th><input type="text" class="form-control default-input" data-column="10" style="width: 70px;"></th>
                                    ...
                                    <th><input type="text" class="form-control default-input" data-column="13" style="width: 80px;"></th>
                                    <th><input type="text" class="form-control default-input" data-column="14" style="width: 50px;"></th>
                                    <th><input type="text" class="form-control default-input" data-column="15" style="width: 50px;"></th>
                                    <th><input type="text" class="form-control default-input" data-column="16" style="width: 60px;"></th>
                                    <th><input type="text" class="form-control default-input" data-column="17" style="width: 50px;"></th>
                                    <th><input type="text" class="form-control default-input" data-column="18" style="width: 50px;"></th>
                                    <th><input type="text" class="form-control default-input" data-column="19" style="width: 80px;"></th>
                                    <th><input type="text" class="form-control default-input" data-column="20" style="width: 90px;"></th>
                                    <th><input type="text" class="form-control default-input" data-column="21" style="width: 130px;"></th>
                                            ...
                                            @endphp
                                                ...
                                                @foreach ($grupo['resultados'] as $resultado)
                                                    <tr data-titulo="{{ $tituloKey }}">
                                                        ...
                                                        <td><input type="text" class="form-control" name='nom[{{ $tituloKey }}][]' value="{{ $resultado['nom'] }}"></td>
                                                        <td><input type="text" class="form-control" name='ext[{{ $tituloKey }}][]' value="{{ $resultado['ext'] }}"></td>
                                                        ...
                                                        <td><input type="text" class="form-control" name='G[{{ $tituloKey }}][]' value="{{ $resultado['G'] }}"></td>
                                                        ...
                                                        <td><input type="text" class="form-control" name='Hora_Tec[{{ $tituloKey }}][]' value="{{ $resultado['Hora_Tec'] }}"></td>
                                                        <td><input type="text" class="form-control" name='sc[{{ $tituloKey }}][]' value="{{ $resultado['sc'] }}"></td>
                                                        ...
                                                        <td><input type="text" class="form-control" name='Perd_Mate[{{ $tituloKey }}][]' value="{{ $resultado['Perd_Mate'] }}"></td>
                        ...
                        <p>
                                        ...
                                        <table>
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>LAMINACIÓN ESCALONADA LINEAL</td>
                                                </tr>
                                            </thead>
                                        </table>
                                    </td>
                                        ...
                                        <table>
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="1" rowspan="2"><strong>ta</strong></td>
                                                    <td colspan="1" rowspan="2">ESPESOR DE LA PARED EN ZONA SANA ADYACENTE</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>PROFUNDIDAD DE LA INDICACIÓN (IN)</td>
                                                </tr>
                                            </thead>
                                        </table>
                                    </td>
                            ...
                            <div class="d-flex justify-content-center align-items-center p-2 bg-primary text-white rounded">FOTOS</div>
                                        ...
                                        <div class="row" id="imageFieldsContainer">
                                            @php
                                                $usadas = []; // Para no repetir imágenes agrupadas
                                            @endphp
                                            ...
                                            @foreach ($fotos as $index => $foto)
                                                ...
                                                @if (!isset($foto['comentario_grupal']))
                                                    <div class="col-sm-6" id="image-container-{{ $foto['id'] }}">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check mt-2">
                                                                <input class="form-check-input" type="checkbox" name="imagen_hoja[]" 
                                                                    id="imagenHoja{{ $foto['id'] }}" value="{{ $foto['id'] }}" checked>
                                                                <label class="form-check-label" for="imagenHoja{{ $foto['id'] }}">
                                                                    Imagen en una hoja
                                                                </label>
                                                            </div>

                                                            <textarea class="form-control mt-2" name="comments[]" id="comment{{ $foto['id'] }}">{{ $foto['comentario'] ?? '' }}</textarea>
                                                            <input type="hidden" name="images_base64[]" id="image{{ $foto['id'] }}-base64" value="">
                                                            <button type="button" class="btn btn-danger mt-2 remove-image" data-index="{{ $foto['id'] }}">Eliminar</button>
                                                        </div>
                                                    </div>

                                                {{-- Caso 2: Grupo de 2 imágenes --}}
                                                @elseif(isset($foto['comentario_grupal']))
                                                    @php
                                                        // Buscar la otra imagen del grupo
                                                        $grupo = collect($fotos)->filter(function ($f) use ($foto) {
                                                            return isset($f['comentario_grupal']) &&
                                                                $f['comentario_grupal'] === $foto['comentario_grupal'];
                                                        });
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        {{-- Comentario grupal --}}
                                                        <textarea class="form-control mt-2 comentario-grupo" name="comentario_grupo[]"
