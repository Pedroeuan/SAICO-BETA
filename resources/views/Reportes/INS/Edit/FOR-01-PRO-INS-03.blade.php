                                                ...
                                                @foreach ($bloque as $item)
                                                    ...
                                                    @if ($item['tipo'] == 'fila')
                                                        <tr data-titulo="{{ $titleId }}">
                                                            ...
                                                            <td><input type="text" class="form-control" name='largo[{{ $titleId }}][]' value="{{ $item['data']['largo'] }}"></td>
                                                            ...
                                                            <td><input type="text" class="form-control" name='long_inspeccionada[{{ $titleId }}][]' value="{{ $item['data']['long_inspeccionada'] }}"></td>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="inputSuccess">SUBIR MANIFIESTO FIRMADO</label>
                                                        <input type="file" class="form-control-file inputForm" name="Detalles_Generales[Reporte_Firmado]"></input>
                                                            @if ($errors->any())
    ...
    let rowCountGlobal = 0; //contador global/visual de filas (se usa para numerar las filas en la tabla).
        ...
        $('#addBtn').click(function () {
            ...
            let newRow = 
                    ...
                    <td><input type="text" class="form-control" name="No[${lastTitle}][]" value="${rowCountGlobal}" placeholder="No. de Junta / Componente"></td>
