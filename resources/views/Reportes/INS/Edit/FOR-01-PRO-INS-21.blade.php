...
@section('title', 'FOR-01-PRO-INS-21')
...
<section class="content w-100">
    <div class="card w-100 p-3">
        <div class="card-body w-100">
            <form id="FOR-01-PRO-INS-21" action="{{ route('Reportes_FOR_01_PRO_INS_21.update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div style="margin-bottom: 2px;"></div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control is-waning @error('Datos_Equipo.Observaciones') is-invalid @enderror" id="inputSuccess" name="Datos_Equipo[Observaciones]" placeholder="Ejemplo: LA INSPECCIÓN SE REALIZÓ DE LADO A Y B">{{ old('Datos_Equipo.Observaciones', $Datos_Equipo['Observaciones'] ?? '') }}</textarea>
                            @error('Datos_Equipo.Observaciones')
                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                            @enderror
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $(document).ready(function() {
        ...
        function actualizarInputsE2() {
            ...
            $('#equiposSelect, #blockyprobetaSelect, #accesoriosSelect1, #accesoriosSelect2, #accesoriosSelect3, #accesoriosSelect4, #accesoriosSelect5, #accesoriosSelect6, #accesoriosSelect7, #accesoriosSelect8, #equiposSelect2, #equiposSelect3')
