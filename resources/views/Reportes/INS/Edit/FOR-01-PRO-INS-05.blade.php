                                ...
                                <div style="margin-bottom: 2px;"></div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" id="tamaño1InputT" name="Datos_Equipo[TAMAÑO1_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.TAMAÑO1_TRANSDUCTORES', $Datos_Equipo['TAMAÑO1_TRANSDUCTORES'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">TAMAÑO:</label>
                                            <input type="text" class="form-control  inputForm" id="tamaño2InputT" name="Datos_Equipo[TAMAÑO2_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.TAMAÑO2_TRANSDUCTORES', $Datos_Equipo['TAMAÑO2_TRANSDUCTORES'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">TAMAÑO:</label>
                                            <input type="text" class="form-control  inputForm" id="tamaño3InputT" name="Datos_Equipo[TAMAÑO3_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.TAMAÑO3_TRANSDUCTORES', $Datos_Equipo['TAMAÑO3_TRANSDUCTORES'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[CORRIENTE1_BLOQUES]" placeholder="" value="{{old('Datos_Equipo.CORRIENTE1_BLOQUES', $Datos_Equipo['CORRIENTE1_BLOQUES'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[DISTANCIA1_BLOQUES]" placeholder="" value="{{old('Datos_Equipo.DISTANCIA1_BLOQUES', $Datos_Equipo['DISTANCIA1_BLOQUES'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">CORRIENTE:</label>
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[CORRIENTE2_BLOQUES]" placeholder="" value="{{old('Datos_Equipo.CORRIENTE2_BLOQUES', $Datos_Equipo['CORRIENTE2_BLOQUES'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputSuccess">DISTANCIA ENTRE PATAS:</label>
                                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[DISTANCIA2_BLOQUES]" placeholder="" value="{{old('Datos_Equipo.DISTANCIA2_BLOQUES', $Datos_Equipo['DISTANCIA2_BLOQUES'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <table id="dynamicTable" class="table table-bordered table-striped dt-responsive tablas w-100">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" name="soldadura[]" value="{{ $junta['soldadura'] ?? ''}}" placeholder="Soldadura" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="evaluacion[]" value="{{ $junta['evaluacion'] ?? '' }}" placeholder="Evaluación" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="forma[]" value="{{ $junta['forma'] ?? '' }}" placeholder="Forma" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="transfer[]" value="{{ $junta['transfer'] ?? '' }}" placeholder="Transfer" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="longitud[]" value="{{ $junta['longitud'] ?? '' }}" placeholder="Longitud" style="width: 100px;"></td>
