...
@section('title', 'FOR-01-PRO-INS-05')
...
<section class="content w-100">
    <div class="card w-100 p-3">
        <div class="card-body w-100">
            <form id="FOR-01-PRO-INS-05" action="{{ route('Reportes_FOR_01_PRO_INS_05.update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div style="margin-bottom: 2px;"></div>
                    ...
                    <div class="d-flex justify-content-center align-items-center p-3 mb-2 bg-secondary text-white rounded">TRANSDUCTORES</div>

                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">ANGULO:</label>
                            <input type="text" class="form-control  inputForm" id="angulo1InputT" name="Datos_Equipo[ANGULO1_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.ANGULO1_TRANSDUCTORES', $Datos_Equipo['ANGULO1_TRANSDUCTORES'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm" id="frecuencia1InputT" name="Datos_Equipo[FRECUENCIA1_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.FRECUENCIA1_TRANSDUCTORES', $Datos_Equipo['FRECUENCIA1_TRANSDUCTORES'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm" id="tamaño1InputT" name="Datos_Equipo[TAMANO1_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.TAMANO1_TRANSDUCTORES', $Datos_Equipo['TAMANO1_TRANSDUCTORES'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">ANGULO:</label>
                            <input type="text" class="form-control  inputForm" id="angulo2InputT" name="Datos_Equipo[ANGULO2_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.ANGULO2_TRANSDUCTORES', $Datos_Equipo['ANGULO2_TRANSDUCTORES'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">FRECUENCIA:</label>
                            <input type="text" class="form-control  inputForm" id="frecuencia2InputT" name="Datos_Equipo[FRECUENCIA2_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.FRECUENCIA2_TRANSDUCTORES', $Datos_Equipo['FRECUENCIA2_TRANSDUCTORES'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">TAMAÑO:</label>
                            <input type="text" class="form-control  inputForm" id="tamaño2InputT" name="Datos_Equipo[TAMANO2_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.TAMANO2_TRANSDUCTORES', $Datos_Equipo['TAMANO2_TRANSDUCTORES'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">ANGULO:</label>
                            <input type="text" class="form-control  inputForm" id="angulo3InputT" name="Datos_Equipo[ANGULO3_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.ANGULO3_TRANSDUCTORES', $Datos_Equipo['ANGULO3_TRANSDUCTORES'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">FRECUENCIA:</label>
                            <input type="text" class="form-control  inputForm" id="frecuencia3InputT" name="Datos_Equipo[FRECUENCIA3_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.FRECUENCIA3_TRANSDUCTORES', $Datos_Equipo['FRECUENCIA3_TRANSDUCTORES'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">TAMAÑO:</label>
                            <input type="text" class="form-control  inputForm" id="tamaño3InputT" name="Datos_Equipo[TAMANO3_TRANSDUCTORES]" placeholder="" value="{{old('Datos_Equipo.TAMANO3_TRANSDUCTORES', $Datos_Equipo['TAMANO3_TRANSDUCTORES'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">MARCA:</label>
                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[AC_MARCA]" placeholder="" value="{{old('Datos_Equipo.AC_MARCA', $Datos_Equipo['AC_MARCA'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[AC_TIPO]" placeholder="" value="{{old('Datos_Equipo.AC_MARCA', $Datos_Equipo['AC_TIPO'] ?? '')}}">
                        </div>
                    </div>

                    <div class="d-flex justify-content-center align-items-centerp-3 mb-2 bg-secondary text-white rounded">BLOQUES</div>

                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">MARCA:</label>
                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[BLOQUES1_MARCA]" placeholder="" value="{{old('Datos_Equipo.BLOQUES1_MARCA', $Datos_Equipo['BLOQUES1_MARCA'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">TIPO:</label>
                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[BLOQUES1_TIPO]" placeholder="" value="{{old('Datos_Equipo.BLOQUES1_TIPO', $Datos_Equipo['BLOQUES1_TIPO'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">MARCA:</label>
                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[BLOQUES2_MARCA]" placeholder="" value="{{old('Datos_Equipo.BLOQUES2_MARCA', $Datos_Equipo['BLOQUES2_MARCA'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">TIPO:</label>
                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[BLOQUES2_TIPO]" placeholder="" value="{{old('Datos_Equipo.BLOQUES2_TIPO', $Datos_Equipo['BLOQUES2_TIPO'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">TIPO:</label>
                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[BLOQUES3_TIPO]" placeholder="" value="{{old('Datos_Equipo.BLOQUES3_TIPO', $Datos_Equipo['BLOQUES3_TIPO'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[NIVEL_ESCANEO]" placeholder="" value="{{old('Datos_Equipo.NIVEL_ESCANEO', $Datos_Equipo['NIVEL_ESCANEO'] ?? '')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control  inputForm" name="Datos_Equipo[SENSIBILIDAD]" placeholder="" value="{{old('Datos_Equipo.SENSIBILIDAD', $Datos_Equipo['SENSIBILIDAD'] ?? '')}}">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm" name="Datos_Equipo[NIVEL_CALIDAD]" placeholder="" value="{{old('Datos_Equipo.NIVEL_CALIDAD', $Datos_Equipo['NIVEL_CALIDAD'] ?? '')}}">
                        </div>
                    </div>
                                            ...
                                            @foreach ($Grupo_Juntas_Re as $bloque)
                                                @foreach ($bloque as $item)
                                                    ...
                                                    @if ($item['tipo'] == 'fila')
                                                        ...
                                                        <td><input type="text" class="form-control" name="dibujo[{{ $titleId }}][]" value="{{ $item['data']['dibujo'] }}"></td>
                                                        <td><input type="text" class="form-control" name="soldadura[{{ $titleId }}][]" value="{{ $item['data']['soldadura'] }}"></td>
                                                        <td><input type="text" class="form-control" name="evaluacion[{{ $titleId }}][]" value="{{ $item['data']['evaluacion'] }}"></td>
                                                        <td><input type="text" class="form-control" name="forma[{{ $titleId }}][]" value="{{ $item['data']['forma'] }}"></td>
                                                        <td><input type="text" class="form-control" name="transfer[{{ $titleId }}][]" value="{{ $item['data']['transfer'] }}"></td>
                                                        <td><input type="text" class="form-control" name="longitud[{{ $titleId }}][]" value="{{ $item['data']['longitud'] }}"></td>
                                                        <td><input type="text" class="form-control" name="ancho[{{ $titleId }}][]" value="{{ $item['data']['ancho'] }}"></td>
