                ...
                <section class="content w-100">
                    <div class="card w-100">
                        <div class="card-body row w-100">
                            <form id="FOR-02-PRO-INS-04" action="{{ route('Reportes_FOR_02_PRO_INS_04.update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <table id="dynamicTable" class="table table-bordered table-striped dt-responsive tablas w-100">
                                        <thead>
                                            ...
                                            <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" name="clasificacion[]" value="{{ $junta['clasificacion'] ?? '' }}" placeholder="Clasificación" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="x[]" value="{{ $junta['x'] ?? '' }}" placeholder="X" style="width: 60px;"></td>
                                                    <td><input type="text" class="form-control" name="y[]" value="{{ $junta['y'] ?? '' }}" placeholder="Y" style="width: 60px;"></td>
                                                    ...
                                                    <td><input type="text" class="form-control" name="tamaño[]" value="{{ $junta['tamaño'] ?? '' }}" placeholder="Tamaño" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="amplitud[]" value="{{ $junta['amplitud'] ?? '' }}" placeholder="Amplitud" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="evaluacion[]" value="{{ $junta['evaluacion'] ?? '' }}" placeholder="Evaluación" style="width: 100px;"></td>
                                                    <td><input type="text" class="form-control" name="comentarios[]" value="{{ $junta['comentarios'] ?? ''}}" placeholder="Comentarios" style="width: 100px;"></td>
...
<script>
    /*Prevenir el Enter*/
    document.getElementById('FOR-02-PRO-INS-04').addEventListener('keydown', function(event) {
            if (event.key === 'Enter') {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    ...
                    <td><input type="text" class="form-control" name="clasificacion[]" placeholder="Clasificación"></td>
                    <td><input type="text" class="form-control" name="x[]" placeholder="X" style="width: 60px;"></td>
                    <td><input type="text" class="form-control" name="y[]" placeholder="Y" style="width: 60px;"></td>
                    ...
                    <td><input type="text" class="form-control" name="tamaño[]" placeholder="Tamaño"></td>
                    <td><input type="text" class="form-control" name="amplitud[]" placeholder="Amplitud"></td>
                    <td><input type="text" class="form-control" name="evaluacion[]" placeholder="Evaluación"></td>
                    <td><input type="text" class="form-control" name="comentarios[]" placeholder="Comentarios"></td>                   
                    <td><button type="button" class="btn btn-danger btnEliminar"><i class="fa fa-times" aria-hidden="true"></i></button></td>
                </tr>`;
