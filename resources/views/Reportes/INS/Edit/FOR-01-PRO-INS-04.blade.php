                ...
                <section class="content w-100">
                    <div class="card w-100">
                        <div class="card-body row w-100">
                            <form id="FOR-01-PRO-INS-04" action="{{ route('Reportes_FOR_01_PRO_INS_04.update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div style="margin-bottom: 2px;"></div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  inputForm" id="freccInputT" name="Datos_Equipo[FRECC_TRANSDUCTOR]" placeholder="" value="{{old('Datos_Equipo.FRECC_TRANSDUCTOR', $Datos_Equipo['FRECC_TRANSDUCTOR'] ?? '')}}">
                                        </div>
                                    </div>
                                    ...
                                    <table id="dynamicTable" class="table table-bordered table-striped dt-responsive tablas w-100">
                                        <thead>
                                            <tr>
                                                <th rowspan="3">No. de Junta</th>
                                                <th rowspan="3">No. Indicación</th>
                                                <th rowspan="3">Ángulo de Inspección</th>
                                                <th rowspan="3">Desde la Cara</th>
                                                <th rowspan="3">Pierna</th>
                                                <th colspan="4">Decibeles</th>
                                                <th colspan="5">Discontinuidad</th>
                                                <th rowspan="3">Clase de la Discontinuidad</th>
                                                <th rowspan="3">Evaluación</th>
                                                <th rowspan="3">Observaciones</th>

                                                <th rowspan="3">Eliminar</th>
                                            </tr>
                                            <tr>
                                                <th>Nivel de Indicación</th>
                                                <th>Nivel de Referencia</th>
                                                <th>Factor de Atenuación</th>
                                                <th>Relación Indicación</th>
                                                <th rowspan="2">Longitud</th>
                                                <th rowspan="2">Distancia Angular</th>
                                                <th rowspan="2">Profundidad desde A</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <td><input type="text" class="form-control" name="angulo_inspeccion[]" value="{{ $junta['angulo_inspeccion'] ?? '' }}" placeholder="Ángulo de Inspección" style="width: 80px;"></td>
                                                        <td><input type="text" class="form-control" name="desde_cara[]" value="{{ $junta['desde_cara'] ?? '' }}" placeholder="Cara" style="width: 80px;"></td>
                                                        <td><input type="text" class="form-control" name="pierna[]" value="{{ $junta['pierna'] ?? '' }}" placeholder="Pierna" style="width: 90px;"></td>
                                                        <td><input type="text" class="form-control" name="decibel_a[]" value="{{ $junta['decibel_a'] ?? '' }}" placeholder="A" style="width: 80px;"></td>
                                                        <td><input type="text" class="form-control" name="decibel_b[]" value="{{ $junta['decibel_b'] ?? '' }}" placeholder="B" style="width: 80px;"></td>
                                                        <td><input type="text" class="form-control" name="decibel_c[]" value="{{ $junta['decibel_c'] ?? '' }}" placeholder="C" style="width: 80px;"></td>
                                                        <td><input type="text" class="form-control" name="decibel_d[]" value="{{ $junta['decibel_d'] ?? '' }}" placeholder="D" style="width: 80px;"></td>
                                                        <td><input type="text" class="form-control" name="longitud[]" value="{{ $junta['longitud'] ?? '' }}" placeholder="Longitud" style="width: 90px;"></td>

                                                        <td><input type="text" class="form-control" name="distancia_angular[]" value="{{ $junta['distancia_angular'] ?? ''}}" placeholder="Distancia Angular" style="width: 90px;"></td>
                                                        <td><input type="text" class="form-control" name="profundidad_a[]" value="{{ $junta['profundidad_a'] ?? '' }}" placeholder="Profundidad A" style="width: 115px;"></td>
                                                        <td><input type="text" class="form-control" name="posicion_x[]" value="{{ $junta['posicion_x'] ?? '' }}" placeholder="X" style="width: 60px;"></td>
                                                        <td><input type="text" class="form-control" name="posicion_y[]" value="{{ $junta['posicion_y'] ?? '' }}" placeholder="Y" style="width: 60px;"></td>
                                                        <td><input type="text" class="form-control" name="discontinuidad[]" value="{{ $junta['discontinuidad'] ?? '' }}" placeholder="Discontinuidad" style="width: 135px;"></td>
                                                        <td><input type="text" class="form-control" name="evaluacion[]" value="{{ $junta['evaluacion'] ?? '' }}" placeholder="Evaluación" style="width: 100px;"></td>
                                                        <td><input type="text" class="form-control" name="observaciones[]" value="{{ $junta['observaciones'] ?? '' }}" placeholder="Observaciones" style="width: 130px;"></td>
...
<script>
    /*Prevenir el Enter*/
    document.getElementById('FOR-01-PRO-INS-04').addEventListener('keydown', function(event) {
            if (event.key === 'Enter') {
        ...
        $('#addBtn').click(function() {
            ...
            for (var i = 0; i < numRows; i++) {
                ...
                var newRow = `<tr>
                    ...
                    <td><input type="text" class="form-control" name="angulo_inspeccion[]" placeholder="Ángulo de Inspección"></td>
                    <td><input type="text" class="form-control" name="desde_cara[]" placeholder="CARA"></td>
                    <td><input type="text" class="form-control" name="pierna[]" placeholder="PIERNA"></td>
                    <td><input type="text" class="form-control" name="decibel_a[]" placeholder="A"></td>
                    <td><input type="text" class="form-control" name="decibel_b[]" placeholder="B"></td>
                    <td><input type="text" class="form-control" name="decibel_c[]" placeholder="C" style="width: 80px;"></td>
                    <td><input type="text" class="form-control" name="decibel_d[]" placeholder="D"></td>
                    <td><input type="text" class="form-control" name="longitud[]" placeholder="Longitud"></td>
                    <td><input type="text" class="form-control" name="distancia_angular[]" placeholder="Distancia Angular"></td>
                    <td><input type="text" class="form-control" name="profundidad_a[]" placeholder="Profundidad A"></td>
                    <td><input type="text" class="form-control" name="posicion_x[]" placeholder="X"></td>
                    <td><input type="text" class="form-control" name="posicion_y[]" placeholder="Y"></td>
                    <td><input type="text" class="form-control" name="discontinuidad[]" placeholder="Discontinuidad"></td>
