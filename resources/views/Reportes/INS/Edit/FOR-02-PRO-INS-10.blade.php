                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr data-titulo="{{ $titleId }}">
                                                        ...
                                                        <td><input type="text" class="form-control" name='no_colada[{{ $titleId }}][]' value="{{ $resultado['no_colada'] }}"></td>
                                                        <td><input type="text" class="form-control" name='tnominal[{{ $titleId }}][]' value="{{ $resultado['tnominal'] }}"></td>
                                                        ...
                                                        <td><input type="text" class="form-control" name='metros_lineales[{{ $titleId }}][]' value="{{ $resultado['metros_lineales'] }}"></td>
