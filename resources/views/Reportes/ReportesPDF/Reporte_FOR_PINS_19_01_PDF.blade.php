<!DOCTYPE html>
        ...
        <head>
            <meta charset="UTF-8">
            <title>FORMATO FOR-PINS-19/01</title>
            <style>
                @page {
                    margin: 
                    /*3.0cm /* superior */
                ...
                .datosgenerales2 th,
                .datosgenerales2 td {
                    padding: 10px 8px; /* Más espacio interno */
                }
                ...
                <table class="datosgenerales2">
                    ...
                    <thead><tr class="sinBordeth"><th colspan="4"></th></tr></thead> <!-- Fila vacia -->
                        ...
                        <tr>
                            ...
                            <td class="lineaInferior" colspan="3">{{ $Datos_Equipo['FRECUENCIA'] }}</td>
                        </tr>
                        <tr>
                            <th>RECUBRIMIENTO:</th>
                            <td class="lineaInferior" colspan="3">{{ $Datos_Equipo['RECUBRIMIENTO'] }}</td>
                        </tr>
                        <tr>
                            <th>MAGNETISMO RESIDUAL:</th>
                            <td class="lineaInferior" colspan="3">{{ $Datos_Equipo['MAGNETISMO'] }}</td>
                        </tr>
                        <tr>
                            <th>DISTANCIA ENTRE MARCAS:</th>
                            <td class="lineaInferior" colspan="3">{{ $Datos_Equipo['DISTANCIA'] }}</td>
                        </tr>
                        <tr>
                            <th>RASTREOS POR ELEMENTO:</th>
                            <td class="lineaInferior" colspan="3">{{ $Datos_Equipo['RASTREOS'] }}</td>
                        </tr>
                        <tr>
                            <th>EXCEPCIONES:</th>
                            <td class="lineaInferior" colspan="3">{{ $Datos_Equipo['EXCEP'] }}</td>
                        </tr>
                        <tr>
                            <th>NOTAS:</th>
                            <td class="lineaInferior" colspan="3">{{ $Datos_Equipo['NOTAS'] }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <body>
            ...
            @php
                ...
                $columnasResultadoPdf = [
                    ['field' => 'no', 'valueKey' => 'no'],
                    ['field' => 'junta', 'valueKey' => 'junta'],
                    ['field' => 'lado', 'valueKey' => 'lado'],
                    ['field' => 'no_ind', 'valueKey' => 'no_ind'],
                    ['field' => 'tipo_ind', 'valueKey' => 'tipo_ind'],
                    ['field' => 'long', 'valueKey' => 'long'],
                    ['field' => 'prof', 'valueKey' => 'prof'],
                    ['field' => 'NR', 'valueKey' => 'NR'],
                    ['field' => 'dnr', 'valueKey' => 'dnr'],
                    ['field' => 'evaluacion', 'valueKey' => 'evaluacion'],
                    ['field' => 'archivo', 'valueKey' => 'archivo'],
                    ['field' => 'long_ins', 'valueKey' => 'long_ins'],
                ];
            @endphp
