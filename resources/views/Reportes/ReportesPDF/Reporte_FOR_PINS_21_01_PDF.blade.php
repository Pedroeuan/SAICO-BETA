<!DOCTYPE html>
        ...
        <head>
            <meta charset="UTF-8">
            <title>FORMATO FOR-PINS-21/01</title>
            <style>
                @page {
                    margin: 
                    /*3.0cm /* superior */
                    ...
                    <thead>
                        <tr>
                            <th rowspan="4" style="width: 450%; font-size: 9pt;">
                                INFORME DE INSPECCIÓN CON ULTRASONIDO POR ARREGLO DE FASES CON EL CODIGO API 1104
                            </th>
                            ...
                            <th style="width: 100%;">FOR-PINS-21/02</th>
                            <th rowspan="4" style="width: 90%;">
        ...
        @php
            ...
            $columnasResultadoPdf = [
                ...
                ['field' => 'Tip_Ind', 'valueKey' => 'Tip_Ind'],
                ['field' => 'L_PGL', 'valueKey' => 'L_PGL'],
                ['field' => 'A_PGL', 'valueKey' => 'A_PGL'],
                ['field' => 'AL_PGL', 'valueKey' => 'AL_PGL'],
                ['field' => 'X', 'valueKey' => 'X'],
                ['field' => 'Y', 'valueKey' => 'Y'],
                ['field' => 'DA_PROF', 'valueKey' => 'DA_PROF'],
                ['field' => 'PA', 'valueKey' => 'PA'],
                ['field' => 'SA', 'valueKey' => 'SA'],
                ['field' => 'TMIN', 'valueKey' => 'TMIN'],
                ['field' => 'SCAN', 'valueKey' => 'SCAN'],
                ['field' => 'EVAL', 'valueKey' => 'EVAL'],
                ...
                <table class="datosinspeccion">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="2">{{ $Datos_Equipo['TIP_BARR'] }}</td>
