        ...
        <body>
            ...
            <header>
                ...
                <table class="datosinspeccion">
                    ...
                    <thead class="encabezadoAzul">
                        <tr><th colspan="4">DATOS DEL SISTEMA DE INSPECCIÓN</th></tr>
                    </thead>  
                    ...
                    <thead><tr class="sinBordeth"><th colspan="4"></th></tr></thead> <!-- Fila vacia -->
                        ...
                        <tr>
                            <th class="celdaGris" style="width: 5%;">MARCA:</th>
                ...
                <table class="datosinspeccion">
                    <tbody>
                        <tr class="celdaGris">
                            ...
                            <th colspan="2">BLOCK DE VERIFICACIÓN /ESTÁNDAR DE REFERENCIA</th>
                        </tr>
                        <tr>
                            <th class="celdaGris" style="width: 5%;">MARCA:</th>
                            <td style="width: 15%;"></td>
                ...
                <table class="datosgenerales">
                    <thead class="encabezadoAzul">
                        <tr><th colspan="4">PLAN DE ESCANEO</th></tr>
                    </thead>  
                    ...
                    <thead><tr class="sinBordeth"><th colspan="4"></th></tr></thead> <!-- Fila vacia -->
                        ...
                        <tr>
                            <th>MAGNETISMO RESIDUAL:</th>
                            <td class="lineaInferior" colspan="3"></td>
                        </tr>
                        <tr>
                            <th>DISTANCIA ENTRE MARCAS:</th>
                            <td class="lineaInferior" colspan="3"></td>
                        </tr>
                        <tr>
                            <th>RASTREOS POR ELEMENTO:</th>
                            <td class="lineaInferior" colspan="3"></td>
                        </tr>
                        <tr>
                            <th>EXCEPCIONES:</th>
                            ...
                            <thead><tr class="sinBordeth"><th colspan="12"></th></tr></thead> <!-- Fila vacia -->
                                ...
                                <thead>
                                    <tr class="celdaGris">
                                        ...
                                        <th style="width: 50px; border: 1px solid black;" rowspan="2">JUNTA/ ELEMENTO</th>
                                        <th style="width: 50px; border: 1px solid black;" rowspan="2">LADO</th>
                                        <th style="width: 40px; border: 1px solid black;" colspan="6">INDICACIÓN</th>
                                        
                                        <th style="width: 24px; border: 1px solid black;" rowspan="2">EVALUACIÓN</th>
                                        <th style="width: 20px; border: 1px solid black;" rowspan="2">ARCHIVO</th>
                                        <th style="width: 20px; border: 1px solid black;" rowspan="2">LONG. INSPECCIONADA</th>
                                    </tr>
                                    ...
                                    <tr class="celdaGris">
                                        ...
                                        <th style="width: 20px; border: 1px solid black;">LONG. mm</th>
                                        <th style="width: 18px; border: 1px solid black;">PROF. Mm</th>
                                        <th style="width: 15px; border: 1px solid black;">NIVEL DE REFERENCIA</th>
                                        <th style="width: 24px; border: 1px solid black;">DNR mm</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php
                                    ...
                                    @foreach ($Grupo_Juntas_Detalles_Re as $grupo)
                                        ...
                                        @foreach ($grupo['resultados'] as $junta)
                                            @php
                                                $contadorFilas++;
                                                $contadorFilasPagina++;
                                                $totalMetros += floatval($junta['long_ins']);
                                            ...
                                            <tr class="juntas">
                                                ...
                                                <td style="@if ($contadorFilas % $filasPorPagina === 0) border-bottom: 2px solid black; @elseif ($esUltimaFila) @if($titulo == 'SIN TITULO') border-bottom: 2px solid black; @endif @endif">{{ $junta['junta'] }}</td>
                                                <td style="@if ($contadorFilas % $filasPorPagina === 0) border-bottom: 2px solid black; @elseif ($esUltimaFila) @if($titulo == 'SIN TITULO') border-bottom: 2px solid black; @endif @endif">{{ $junta['lado'] }}</td>
                                                ...
                                                <td style="@if ($contadorFilas % $filasPorPagina === 0) border-bottom: 2px solid black; @elseif ($esUltimaFila) @if($titulo == 'SIN TITULO') border-bottom: 2px solid black; @endif @endif">{{ $junta['tipo_ind'] }}</td>
                                                <td style="@if ($contadorFilas % $filasPorPagina === 0) border-bottom: 2px solid black; @elseif ($esUltimaFila) @if($titulo == 'SIN TITULO') border-bottom: 2px solid black; @endif @endif">{{ $junta['long'] }}</td>
                                                ...
                                                <td style="@if ($contadorFilas % $filasPorPagina === 0) border-bottom: 2px solid black; @elseif ($esUltimaFila) @if($titulo == 'SIN TITULO') border-bottom: 2px solid black; @endif @endif">{{ $junta['dnr'] }}</td>
                                                ...
                                                <td style="@if ($contadorFilas % $filasPorPagina === 0) border-bottom: 2px solid black; @elseif ($esUltimaFila) @if($titulo == 'SIN TITULO') border-bottom: 2px solid black; @endif @endif">{{ $junta['archivo'] }}</td>
                                                <td style="border-right: 2px solid black;@if ($contadorFilas % $filasPorPagina === 0) border-bottom: 2px solid black; @elseif ($esUltimaFila) @if($titulo == 'SIN TITULO') border-bottom: 2px solid black; @endif @endif">{{ $junta['long_ins'] }}</td>
                                            </tr>
                                                ...
                                                @if ($contadorFilas % $filasPorPagina === 0)
                                                    ...
                                                    <tr style="page-break-after: always;" class="sinBordetd">
                                                        ...
                                                        <th style="border-right: 1px solid black; border-left: 2px solid black; border-bottom: 2px solid black;"><strong>TOTAL:</strong></th>
