<!DOCTYPE html>
        ...
        <head>
            <meta charset="UTF-8">
            <title>FORMATO FOR-INS-21/01</title>
            <style>
                @page {
                    margin: 
                    /*3.0cm /* superior */
        ...
        <body>
            ...
            <header>
                <table class="tablaheader">
                    ...
                    <tbody>
                        <tr>
                            <th rowspan="2" style="font-size: 9pt;"> INFORME DE INSPECCIÓN DE SOLDADURAS CON ULTRASONIDO POR ARREGLO DE FASES, DE ACUERDO CON API 1104 </th>
                            <th>Versión</th>
                            <th>0</th>
                        </tr>
                        <tr>
