                ...
                <div class="box">
                    ...
                    <div class="box-b">
                        <table class="mini">
                            ...
                            <tr><th>Liquido de frenos</th><td>{{ ucfirst(str_replace('_', ' ', $cs?->condicion?->liquido_frenos ?? 'n/a')) }}</td></tr>
                    ...
                    <div class="box-b">
                        @if($ce)
                            <table class="mini">
                                ...
                                <tr><th>Liquido de frenos</th><td>{{ ucfirst(str_replace('_', ' ', $ce?->condicion?->liquido_frenos ?? 'n/a')) }}</td></tr>
