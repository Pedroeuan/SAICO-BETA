...
//dd($id);
@endphp
<form id="UsuarioForm" method="post" enctype="multipart/form-data" action="{{ route('editar.usuarios', ['id' => $id]) }}">
    @csrf
        ...
        <div class="card">
            <div class="card-body row">
                <div class="col-5 text-center d-flex align-items-center justify-content-center">
                    <div class>
                        <h2>Actualizar un nuevo usuario</h2>
                        <br>
                    ...
                    <div class="col-7">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('Telefono') is-invalid @enderror" placeholder="9381092634" name="Telefono" value="{{ $Usuario->telefono }}">
                            @error('Telefono')
                                    <div class="invalid-feedback"><span>{{ $message }}</span></div>
                            @enderror
                        </div>
