    ...
    <table class="tablaheader">
        <thead>
            <tr>
                ...
                <td class="" style="width: 80px;">FOR-PINS-04/01</td>
        ...
        <tbody>
            <tr>
                <th rowspan="2" style="width: 500px;"> INFORME DE INSPECCIÓN CON LÍQUIDOS PENETRANTES </th>
    ...
    <table class="sinBorde">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="lineaInferior"></td>
                <td class="datosGeneralesCortos" style="width: 120px;">CÓDIGO APLICABLE:</td>
                <td class="lineaInferior"></td>
            </tr>
        </tbody>
    </table>
