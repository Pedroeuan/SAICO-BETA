...
<br>
<br>
    <div class="col-15 text-center d-flex align-items-center justify-content-center">
        <div class>
...
<!-- form start -->
    <div class="card-body">
        <form id="form-solicitud" method="POST" enctype="multipart/form-data" action="{{ route('ADsolicitud.update', ['id' => $id]) }}">
            @csrf
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" class="form-control" id="fecha" name="fecha" value="{{ date('Y-m-d') }}" @if ($rol == 'Administrador' || $rol == 'Super Administrador') require @else readonly  @endif>
                        </div>

                        <div class="col-md-4 mb-3">
                            <label for="estatus" class="form-label">Estatus</label>
                            @if ($rol == 'Administrador' || $rol == 'Super Administrador')
                            <select class="form-control" id="estatus" name="estatus" require>
                            ...
                            @else
                            <input type="text" class="form-control" id="estatus" name="estatus" value="{{ $solicitud->estatus }}" readonly>
                            @endif
                        </div>

                        <div class="col-md-4 mb-3">
                            <label for="TEMA" class="form-label">Tema Principal</label>
                            <input type="text" class="form-control" id="TEMA" name="Tema" placeholder="Ejemplo: SERVICIO PROTEXA" value="{{ $solicitud->Tema }}" required>
                        </div>
