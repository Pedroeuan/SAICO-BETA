                ...
                <div class="card-body">
                    <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_1">
                                <form id="NormasIMForm" method="post" enctype="multipart/form-data" action="{{route('Normas_IM.store')}}">
                                    @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control inputForm @error('NombreESP') is-invalid @enderror" value="{{old('NombreESP')}}" name="NombreESP" placeholder="Ejemplo: ASTM A105" >
                                                    @error('NombreESP')
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control inputForm" value="{{old('Variable')}}" name="Variable" placeholder="Ejemplo: Over 3⁄4 in. (19 mm) to 1 1⁄2 in. (38 mm)" >
                                                </div>
                                            </div>
                                    ...
                                    {{--<input type="hidden" name="Normas_IM" id="Normas_IM">--}}
                                        ...
                                        <button id="addBtn" type="button" class="btn btn-success custom-btn">Agregar Fila</button>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control is-waning" id="inputSuccess" name="Observaciones" placeholder="Ejemplo:">{{ old('Observaciones') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="container">
